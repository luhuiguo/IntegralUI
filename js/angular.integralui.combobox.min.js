...
scope:{controlStyle:"=",dropdownHeight:"=",dropdownWidth:"=",enabled:"=",fields:"=",integralHeight:"=",itemIcon:"=",items:"=",maxDropdownItems:"=",name:"@",options:"=?",rtl:"=",selectedItem:"=",showIcons:"=",click:"&",enabledChanged:"&",events:"=?",dropdownClosed:"&",dropdownClosing:"&",dropdownOpened:"&",dropdownOpening:"&",selectedItemChanged:"&",styleChanged:"&"},link:function(h,l,c,a,B){var q=this,m=l.children().eq(0),w=l.children().eq(1),e=g.getUniqueId(4);h.listOptions={};var x=function(){h.listOptions=
{controlStyle:a.options.controlStyle.list,itemIcon:a.options.itemIcon,navSelection:!1,rtl:a.options.rtl,showIcons:a.options.showIcons}},u=null,v='<iui-list name="'+e+'" style="position:absolute;" items="items" fields="fields" options="listOptions" after-select="onItemSelected(e)"></iui-list>',n=null,t=!1,y=0,H=0,I=0,M=function(){if(u&&angular.isDefined(h.items)&&0<h.items.length){var a=g.getUniqueId(4),e=b('<iui-list name="'+a+'" style="position:absolute;top:-99px;height:100px" items="items" item-icon="itemIcon"></iui-list>')(h);
angular.element(u).append(e);d.updateLayout(a);var c=k(function(){if(0<e.children().length){var a=e.children().eq(0);0<a.children().length&&(I=angular.element(a.children().eq(0))[0].offsetHeight)}e.remove();k.cancel(c)},1)}};a.openDropDown=function(){D()};a.closeDropDown=function(){A()};var D=function(c){if(!t&&0!=a.callDropDownOpening()&&(n&&n.remove(),u)){x();v='<iui-list name="'+e+'" style="position:absolute;" items="items" fields="fields" options="listOptions" after-select="onItemSelected(e)" lost-focus="onListLostFocus(e)" tabindex="999"></iui-list>';
n=b(v)(h);M();var g=k(function(){l.css("border-bottom-left-radius","0px");l.css("border-bottom-right-radius","0px");var b=l[0].getBoundingClientRect(),c=angular.element(f)[0].pageXOffset,x=angular.element(f)[0].pageYOffset,x=b.bottom+x-1,b=b.left+c,c=parseInt(getComputedStyle(l[0]).width,10);c<a.options.dropDownWidth&&(c=a.options.dropDownWidth);var p=a.options.dropDownHeight;a.options.integralHeight&&(p=I*a.options.maxDropDownItems);n.css("top",x+"px");n.css("left",b+"px");n.css("width",c+"px");
n.css("height",p+"px");n.css("z-index","999");angular.element(u).append(n);x=a.getList();!a.options.selectedItem&&x&&0<x.length&&(a.options.selectedItem=x[0]);d.selectedItem(e,a.options.selectedItem);d.updateLayout(e);var h=k(function(){d.ensureVisible(e,a.options.selectedItem);var b=k(function(){d.focus(e,a.options.selectedItem);k.cancel(b)},1);t=!0;a.callDropDownOpened();k.cancel(h)},10);k.cancel(g)},1)}},A=function(){n&&t&&0!=a.callDropDownClosing()&&(n.remove(),l.css("border-bottom-left-radius",
y+"px"),l.css("border-bottom-right-radius",H+"px"),l[0].focus(),t=!1,a.callDropDownClosed())};h.$on("$destroy",function(a){q.s2t();l.unbind("click dblclick keydown mousedown mouseleave mousemove");angular.element(f).unbind("click mousemove mousedown mouseup");K();itemScope&&itemScope.$destroy()});h.onItemSelected=function(e){a.selectItem(e.item);A()};h.onListLostFocus=function(a){A()};var K=function(){l.unbind("click dblclick keydown mousedown mouseleave mousemove touchstart")},E=function(){1==a.options.enabled&&
(l.bind("click",function(e){a.callClick();e.stopPropagation()}),l.bind("keydown",function(a){switch(a.keyCode){case 13:t?A():D(a),a.stopPropagation()}}),l.bind("mousedown",function(a){t?A():D(a);a.stopPropagation()}),l.bind("touchstart",function(e){e.preventDefault();var b=g.getTouchData(e);b&&0<b.length&&(a.callClick(),t?A():D(e),e.stopPropagation())}))};angular.element(f).bind("mousedown",function(a){A()});var G=function(e){var b="";e[a.options.dataFields.icon]?b=e[a.options.dataFields.icon]:a.options.itemIcon&&
(b=a.options.itemIcon);return b};a.updateLayout=function(){x();a.refresh();var e=k(function(){u=g.getBodyElem(l[0]);y=parseInt(getComputedStyle(l[0])["border-bottom-left-radius"],10);H=parseInt(getComputedStyle(l[0])["border-bottom-right-radius"],10);K();a.updateCombo();var b="ltr";!0===a.options.rtl&&(b="rtl");l.css("direction",b);b=w[0].offsetHeight;b<m[0].offsetHeight&&(b=m[0].offsetHeight);var c=g.getPadding(l[0]),b=a.options.selectedItem&&""!=a.options.selectedItem[a.options.dataFields.text]?
b+c.bottom:b+(c.top+c.bottom+1);l.css("height",b+"px");E();k.cancel(e)},1)};var C=null;a.updateCombo=function(){C&&C.remove();var e=a.options.selectedItem,b=g.getMargin(w[0]),c=g.getPadding(m[0]);a.options.showIcons&&e&&e&&(e.icon||a.options.itemIcon)?(C=angular.element('<span class="'+G(e)+'" data-element="icon" style="display:inline-block"></span>'),l.prepend(C),e=g.getMargin(C[0]),m.css("width",l[0].clientWidth-(c.left+c.right+C[0].offsetWidth+e.left+e.right+w[0].offsetWidth+b.left+b.right+8)+
"px")):m.css("width",l[0].clientWidth-(c.left+c.right+w[0].offsetWidth+b.left+b.right+8)+"px");a.options.selectedItem&&m.html(a.options.selectedItem[a.options.dataFields.text])};a.refresh=function(){var e=a.defaultStyle.general.normal;a.options.controlStyle&&(e!=a.options.controlStyle.general.normal&&(e+=" "+a.options.controlStyle.general.normal),0==a.options.enabled&&a.options.controlStyle.general.disabled&&g.isString(a.options.controlStyle.general.disabled)&&(e+=" "+a.options.controlStyle.general.disabled));
l.removeAttr("class");l.addClass(e);0<w.length&&(e=a.defaultStyle.button.dropdown.normal,a.options.controlStyle&&(e!=a.options.controlStyle.button.dropdown.normal&&(e+=" "+a.options.controlStyle.button.dropdown.normal),0==a.options.enabled&&a.options.controlStyle.button.dropdown.disabled&&g.isString(a.options.controlStyle.button.dropdown.disabled)&&(e+=" "+a.options.controlStyle.button.dropdown.disabled)),w.removeAttr("class"),w.addClass(e));0<m.length&&(e=a.defaultStyle.content.normal,a.options.controlStyle&&
...
"iui-list-item-content-hovered"),selected:g.isFieldAvailable(b.selected,"iui-list-item-content-selected")}:a.options.controlStyle.item.content;return{general:c,checkBox:d,content:b}}return a.options.controlStyle.item};this.updateControlStyle=function(b){a.options.controlStyle=b?{general:g.isFieldAvailable(b.general,"iui-list"),item:w(b.item)}:{general:g.isFieldAvailable(a.defaultStyle.general,"iui-list"),item:w(a.defaultStyle.item)}};this.getCurrentItemStyle=function(b,c){var d=a.options.controlStyle.item;
...
w=function(){var a="iui-list-block";c.options.showStatusIcons&&(a+=" "+a+"-shift-left");c.options.rtl&&(a+=" "+a+"-rtl");return a};d.$on("$destroy",function(a){h.unbind("click blur dblclick keydown mousedown mouseleave mousemove mousewheel scroll");e();v&&v.$destroy()});h.bind("blur",function(a){c.callLostFocus()});var e=function(){var a=q.find("li");if(0<a.length)for(var b=0;b<a.length;b++)currentElem=angular.element(a[b]),currentElem.unbind("click blur dragstart dragover drop dragenter dragleave dblclick keydown keypress keyup mouseenter mouseleave mousedown mouseup touchstart")},
x=function(a){if(a){if(1==c.options.allowFocus){var b=c.getTabIndex().toString()+(c.getItemCurrentIndex(c.getItemFromElem(a))+1).toString();a.attr("tabindex",b)}a.bind("click",function(a){if(1===a.which){var b=c.getItemFromElem(this);b&&c.callItemClick(b,g.getMousePos(a))}a.stopPropagation()});a.bind("dblclick",function(a){a.preventDefault();if(1===a.which){var b=c.getItemFromElem(this);b&&c.callItemDblClick(b,g.getMousePos(a))}a.stopPropagation()});a.bind("mousedown",function(a){var b=c.getItemFromElem(this);
if(b)switch(c.itemSelection(b,!0,!0),a.which){case 1:c.changeCheckValue(b);break;case 3:c.callItemRightClick(b,g.getMousePos(a))}a.stopPropagation()});a.bind("mouseup",function(a){});a.bind("mouseenter",function(a){if(a=c.getItemFromElem(this))angular.element(this),c.hoverItem=a,c.refresh(),c.callItemHover(a)});a.bind("mouseleave",function(a){c.hoverItem=null;c.getItemFromElem(this)&&c.refresh()});a.bind("touchstart",function(a){a.preventDefault();var b=g.getTouchData(a);if(b&&0<b.length){if(b=c.getItemFromElem(this))c.itemSelection(b,
!0,!0),c.changeCheckValue(b);a.stopPropagation()}});a.bind("blur",function(a){var b=c.getItemFromElem(this);if(b)var d=k(function(){var a=angular.element(document.activeElement);a&&(!a[0].attributes["data-element"]||a[0].attributes["data-element"]&&"list"!=a[0].attributes["data-element"].value)&&c.callLostFocus(b);k.cancel(d)},1)})}var e=function(a,b){a.preventDefault();focusDelayTime=0;var e=c.getItemCurrentIndex(b),g=u+y-2,g=g<c.currentList.length-1?g:c.currentList.length-1;e===g&&(c.setScrollPos({x:c.scrollPos.x,
y:c.scrollPos.y+Math.floor(h[0].clientHeight/4)}),focusDelayTime=1);var f=c.getNextItem(e);if(f){c.itemSelection(f);d.$apply();var r=k(function(){c.updateFocus(f);k.cancel(r)},focusDelayTime)}},f=function(a,b){a.preventDefault();focusDelayTime=0;var e=c.getItemCurrentIndex(b),g=u;e===(0<g?g:0)&&(c.setScrollPos({x:c.scrollPos.x,y:c.scrollPos.y-Math.floor(h[0].clientHeight/4)}),focusDelayTime=1);var f=c.getPrevItem(c.getItemCurrentIndex(b));if(f){c.itemSelection(f);d.$apply();var r=k(function(){c.updateFocus(f);
k.cancel(r)},focusDelayTime)}};a.bind("keydown",function(a){var b=c.getItemFromElem(this);if(b){var r=0;switch(a.keyCode){case 9:var h=c.currentList.length;0<h&&(a.shiftKey?g.isEqual(b[c.options.dataFields.id],c.currentList[0][c.options.dataFields.id])||f(a,b):g.isEqual(b[c.options.dataFields.id],c.currentList[h-1][c.options.dataFields.id])||e(a,b));break;case 13:c.itemSelection(b,!0,!0);break;case 33:a.preventDefault();r=c.getItemCurrentIndex(b);h=r-y;h=0<h?h:0;if(h!==r){var r=1,L=c.getPrevItem(h+
1);if(L){c.scrollTo(L);c.itemSelection(L);d.$apply();var l=k(function(){c.updateFocus(L);k.cancel(l)},r)}}break;case 34:a.preventDefault();r=c.getItemCurrentIndex(b);h=r+y;h=h<c.currentList.length-1?h:c.currentList.length-1;h!==r&&(r=1,L=c.getNextItem(h-1))&&(c.scrollTo(L,"bottom"),c.itemSelection(L),d.$apply(),l=k(function(){c.updateFocus(L);k.cancel(l)},r));break;case 35:a.preventDefault();c.setScrollPos({x:c.scrollPos.x,y:J.y});var m=c.getLastItem();m&&(c.itemSelection(m),l=k(function(){c.updateFocus(m);
k.cancel(l)},1));break;case 36:a.preventDefault();c.setScrollPos({x:c.scrollPos.x,y:0});var n=c.getFirstItem();n&&(c.itemSelection(n),l=k(function(){c.updateFocus(n);k.cancel(l)},1));break;case 38:f(a,b);break;case 40:e(a,b)}}c.callKeyDown(a,b)});a.bind("keyup",function(a){var b=c.getItemFromElem(this);c.callKeyUp(a,b)});a.bind("keypress",function(a){var b=c.getItemFromElem(this);c.callKeyPress(a,b)})},u=0,v=null,n=100,t=0,y=0,H=0,I=0,M=!1,D=9,A=0,K=0,E=0,G=0,C=1,p=null,z=!1;this.scrollMousePos=null;
var J={x:0,y:0},K=0;c.updateViewSize=function(){var a=k(function(){z=!1;if(0<c.currentList.length){var e=angular.element(b(V(0,!0))(d));h.append(e);var f=g.getMargin(e[0]);t=e[0].offsetHeight+(f.top+f.bottom);n=Math.floor((h[0].offsetHeight-6)/t)+1;z=!1;n<c.currentList.length+1&&(m.unbind("click mousedown mouseup"),h.append(m),m.bind("click",function(a){a.stopPropagation()}),m.bind("mousedown",function(a){h[0].focus();a=g.getClientMousePos(a,this);var b=Math.floor(h[0].clientHeight);p&&(a.y<p[0].offsetTop?
(c.setScrollPos({x:c.scrollPos.x,y:c.scrollPos.y-b}),W(!1,b)):a.y>p[0].offsetTop+p[0].offsetHeight&&(c.setScrollPos({x:c.scrollPos.x,y:c.scrollPos.y+b}),W(!0,b)))}),m.bind("mouseup",function(a){a.stopPropagation()}),p=angular.element(m.children().eq(0)),z=!0,p.bind("mousedown",function(a){1===a.which&&(h[0].focus(),B.scrollMousePos=g.getMousePos(a),M=!0);a.stopPropagation()}));e.remove()}z||(m.unbind("click mousedown mouseup"),m.remove());k.cancel(a);!z&&0<c.scrollPos.y&&c.setScrollPos({x:0,y:0})},
1)};var R=function(){var a=k(function(){H=h[0].offsetWidth-6;I=h[0].offsetHeight-6;I-=4;H=z?H-m[0].offsetWidth:H-4;q.css("width",H+"px");q.css("height",I+"px");z&&(m.css("top","0px"),I+=3,m.css("height",I+1+"px"));!1!==c.options.rtl?(q.css("left","auto"),q.css("right","-"+(c.scrollPos.x-2).toString()+"px"),z&&(m.css("left","0px"),m.css("right","auto"))):(q.css("left","-"+(c.scrollPos.x-2).toString()+"px"),q.css("right","auto"),z&&(m.css("left","auto"),m.css("right","0px")));var b=k(function(){var a=
c.currentList.length+1;z&&0<c.currentList.length&&n<a&&(E=2,G=m[0].clientHeight-4,A=0,G>E&&(A=G-E),D=Math.floor(A*n/a),9>D&&(D=9),p.css("height",D+"px"),C=(a-n)/(A-D-2),J.y=(a-n)*t,0>J.y&&(J.y=0),0==u?p.css("top",E+"px"):u+n-1==c.currentList.length&&p.css("top",G-p[0].offsetHeight+"px"));k.cancel(b)},1);k.cancel(a)},5)};c.updateLayout=function(a){c.allowUpdate&&(h.removeClass("iui-list-block-rtl"),c.options.rtl&&h.addClass("iui-list-block-rtl"),q.removeClass("iui-list-block-shift-left iui-list-block-rtl"),
q.addClass(w()),t=0,n=100,n=Math.floor(h[0].clientHeight/20),c.updateCurrentList(),X(),c.updateView(a),c.updateView(a),k(function(){c.updateViewSize();c.updateViewSize();R()},1))};d.onCheckValueChanging=function(a,b){return c.callCheckValueChanging(c.currentList[b],c.options.checkBoxSettings&&1==c.options.checkBoxSettings.threeState?a.checkState:a.checked)};d.onCheckValueChanged=function(a,b){c.callCheckValueChanged(c.currentList[b],c.options.checkBoxSettings&&1==c.options.checkBoxSettings.threeState?
a.checkState:a.checked)};var V=function(a,b){var d=c.currentList[a],e=c.defaultStyle.item.general.normal,f=c.getCurrentItemStyle(d,c.getObjState(d)),d='<li class="'+e;f!=e&&(d+=" "+f);d+='" ';d=b?d+'style="position:absolute;top:-9999px;':d+('data-index="'+a+'"');c.currentList[a].content||(d+=' iui-tooltip="data['+a+"]."+c.options.dataFields.tooltip+'"');d+=">";1==c.options.showCheckBoxes&&(d+='<iui-checkbox name="cb-'+g.getUniqueId(4)+'"',e=c.options.checkBoxSettings?1==c.options.checkBoxSettings.threeState:
!1,f=c.currentList[a],e&&void 0==f[c.options.dataFields.checkState]?f[c.options.dataFields.checkState]="unchecked":void 0==f[c.options.dataFields.checked]&&(f[c.options.dataFields.checked]=!1),e?(d+=' check-state="data['+a+"]."+c.options.dataFields.checkState+'"',d=d+(' checkstate-changing="onCheckValueChanging(e, '+a+')"')+(' checkstate-changed="onCheckValueChanged(e, '+a+')"')+' three-state="true"'):(d+=' checked="data['+a+"]."+c.options.dataFields.checked+'"',d=d+(' checked-changing="onCheckValueChanging(e, '+
a+')"')+(' checked-changed="onCheckValueChanged(e, '+a+')"')),c.options.checkBoxSettings&&c.options.checkBoxSettings.style&&v&&v.checkBoxStyle?d+=' control-style="checkBoxStyle"':c.options.controlStyle.item.checkBox&&v&&v.checkBoxStyle&&(d+=' control-style="checkBoxStyle"'),c.isItemEnabled(c.currentList[a])||(d+=' enabled="false"'),d+=' style="display:inline-block;margin:0 2px;padding-bottom:2px;vertical-align:middle;',0<O&&(d+="width: "+O+"px;"),d+='"></iui-checkbox>');0!=c.options.showIcons&&(c.currentList[a].icon||
c.options.itemIcon)&&(e=c.currentList[a],f="",e[c.options.dataFields.icon]?f=e[c.options.dataFields.icon]:c.options.itemIcon&&(f=c.options.itemIcon),d+='<span class="'+f+'" data-element="icon"></span>');e=c.defaultStyle.item.content.normal;c.options.controlStyle.item.content.normal!=e&&(e+=" "+c.options.controlStyle.item.content.normal);f=c.getCurrentItemContentStyle(c.currentList[a],"normal");c.currentList[a].content?(d=d+('<div class="'+e+" "+f+'" data-element="content">')+c.currentList[a][c.options.dataFields.content],
d+="</div>"):(d+='<span class="'+e+" "+f+'" data-element="content"',!b&&c.currentList[a].contextMenu&&(d+=' iui-contextmenu menu-items="data['+a+'].contextMenu"'),d+=">",d=b?d+c.currentList[a][c.options.dataFields.text]:d+("{{data["+a+"]."+c.options.dataFields.text+"}}"),d+="</span>");return d+="</li>"},O=0,X=function(){if(1==c.options.showCheckBoxes){var a=angular.element(b('<iui-checkbox style="position:absolute;top:-9999px"></iui-checkbox>')(d));h.append(a);O=0;a&&0<a.children().length&&(O=parseInt(getComputedStyle(angular.element(a.children().eq(0))[0]).width,
10));a.remove()}};c.updateView=function(a){var f=k(function(){M||R();e();q.empty();v&&v.$destroy();S(!1);c.currentList.length>=n&&u+n-1>c.currentList.length&&(u=c.currentList.length-n+1);if(u<c.currentList.length){v=d.$new();v.data=c.currentList;v.checkBoxStyle=c.options.checkBoxSettings.style;!v.checkBoxStyle&&c.options.controlStyle.item.checkBox&&(v.checkBoxStyle=c.options.controlStyle.item.checkBox);y=0;var a;firstItemElem=null;var r;g.getMargin();for(var l=0,m=u;m<u+n&&m<c.currentList.length;m++)a=
V(m),a=c.currentList[m].content?b(a)(d.$parent):b(a)(v),a=angular.element(a),q.append(a),r=g.getMargin(a[0]),l+=a[0].offsetHeight+(r.top+r.bottom),y++;if(0<y){a=q.find("li");if(0<a.length)for(var p=0;p<a.length;p++)r=angular.element(a[p]),(m=c.getItemFromElem(r))&&c.isItemEnabled(m)&&x(r);m=h[0].offsetHeight-6;t=l/y;n=Math.floor(m/t)+1;R()}c.refresh()}k.cancel(f)},1)};c.refresh=function(a){if(a){var b;switch(a.type){case "item":if(b=c.getElemFromItem(a)){b.removeAttr("class");b.addClass(c.defaultStyle.item.general.normal);
b.addClass(c.options.controlStyle.item.general.normal);var d=c.getCurrentItemStyle(a,c.getObjState(a));d!=c.options.controlStyle.item.general.normal&&b.addClass(d);if(b=c.getElement(b))b.removeAttr("class"),b.addClass(c.defaultStyle.item.content.normal),b.addClass(c.options.controlStyle.item.content.normal),d=c.getCurrentItemContentStyle(a,c.getObjState(a)),d!=c.options.controlStyle.item.content.normal&&b.addClass(d)}}}else for(a=c.defaultStyle.general,c.options.controlStyle&&a!=c.options.controlStyle.general&&
(a+=" "+c.options.controlStyle.general),h.removeAttr("class"),h.addClass(a),a=u;a<u+n&&a<c.currentList.length;a++)c.refresh(c.currentList[a])};var P=!1,N=0,Q=null,T=.5;c.isScrollBarVisible=function(){return z};c.scrollPos={x:0,y:0};c.getScrollPos=function(){return c.scrollPos};c.setScrollPos=function(a){a&&(a.x=0,0>a.y&&(a.y=0),a.y>J.y&&(a.y=J.y),c.scrollPos=a,K=Math.floor(c.scrollPos.y/(t*C)),a=E+K,z&&p&&p.css("top",a+"px"),S(),angular.isDefined(d.events)&&d.events.scrollPosChanged?d.events.scrollPosChanged({scrollPos:c.scrollPos}):
d.scrollposChanged({e:{scrollPos:c.scrollPos}}))};var W=function(a,b,d){P||(N=0,P=!0,Q=F(function(){var d=b,e=c.getScrollPos();d||(0===N&&(N=5),N+=5+C,T+=.5,d=N+=Math.floor(T));e.y=a?e.y+d:e.y-d;c.setScrollPos(e);(0>=e.y||c.getScrollPos().y<e.y)&&U()},d?d:100))},U=function(){P&&(Q&&(F.cancel(Q),Q=null),P=!1,N=0,T=.5)};c.cancelScrollTimer=function(){U()};c.scrollTo=function(a,b){if(a){var d=c.getItemCurrentIndex(a);if(c.isIndexInRange(d)){var e=0,f=d;switch(b){case "center":e=Math.floor(y/2);f=d>e?
d-e:0;break;case "bottom":e=y-2,f=d>e?d-e:0}var g=k(function(){c.setScrollPos({x:c.scrollPos.x,y:f*t});k.cancel(g)},1)}}};var S=function(a,b){if(!(0==a&&0>=t)){newIndex=0<t?Math.floor(c.scrollPos.y/t):0;if(b||newIndex+n-1>c.currentList.length)newIndex=c.currentList.length-n+1;0>newIndex&&(newIndex=0);newIndex!==u&&(u=newIndex,0!=a&&c.updateView(!0))}};h.bind("scroll",function(a){h[0].scrollTop=0;h[0].scrollLeft=0});h.bind("mousewheel",function(a){a.preventDefault();c.hoverItem=null;var b=0;a.wheelDelta?
b=Math.max(-1,Math.min(1,a.wheelDelta||-a.detail)):a.originalEvent&&(b=Math.max(-1,Math.min(1,a.originalEvent.wheelDelta||-a.originalEvent.detail)));c.setScrollPos({x:c.scrollPos.x,y:c.scrollPos.y+Math.floor(h[0].clientHeight/4)*b*-1});k(function(){var b=g.getMousePos(a),d=angular.element(f)[0].pageXOffset,e=angular.element(f)[0].pageYOffset;b.x-=d;b.y-=e;if(b=c.getItemAt(b.x,b.y))c.hoverItem=b,c.refresh()},1)});angular.element(f).bind("mousemove",function(a){if(M&&1===a.which){p[0].getBoundingClientRect();
a=g.getMousePos(a);B.scrollMousePos||(B.scrollMousePos=a);var b=p[0].offsetTop+(a.y-B.scrollMousePos.y);b<E?b=E:b+p[0].offsetHeight>G&&(b=G-p[0].offsetHeight);p.css("top",b+"px");B.scrollMousePos=a;K=b-E;c.scrollPos.y=b+p[0].offsetHeight>=G?J.y:Math.floor(K*C*t);S(!0,c.scrollPos.y==J.y)}});angular.element(f).bind("mouseup",function(a){M&&c.updateView();U();B.scrollMousePos=null;M=!1});angular.isDefined(d.options)?c.updateOptions(d.options):(0==d.allowFocus&&(c.options.allowFocus=d.allowFocus),angular.isDefined(d.checkboxSettings)&&
c.updateCheckBoxSettings(d.checkboxSettings),angular.isDefined(d.controlStyle)&&c.updateControlStyle(d.controlStyle),angular.isDefined(d.fields)&&(c.updateDataFields(d.fields),c.updateData()),angular.isDefined(d.itemIcon)&&(c.options.itemIcon=d.itemIcon),angular.isDefined(d.navSelection)&&(c.options.navSelection=d.navSelection),!0===d.rtl&&(c.options.rtl=d.rtl),angular.isDefined(d.selectedIndex)&&(c.options.selectedIndex=d.selectedIndex),angular.isDefined(d.selectedItem)&&(c.options.selectedItem=
d.selectedItem),!0===d.showCheckBoxes&&(c.options.showCheckBoxes=d.showCheckBoxes),!1===d.showIcons&&(c.options.showIcons=d.showIcons));c.updateLayout()}}}]);