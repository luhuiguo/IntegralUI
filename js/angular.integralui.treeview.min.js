...
{autoCheck:!1,style:b.defaultCheckBoxStyle,threeState:!1}};var C=function(d){return d?a.createTree(d.conditions,d.formula):null},J=function(d){var l=!0;d&&b.filterParams&&(l=(l=d[b.options.dataFields.value])?l:d[b.options.dataFields.text],l=b.filterParams.callback?b.filterParams.callback(l,d):a.match(l,b.filterParams.conditions,b.filterParams.formula,C(b.filterParams)));return l},y=0;b.currentList=[];b.indentList=[];b.parentList=[];b.longestItem=null;b.isThereChildItems=!1;b.currentTopList=[];b.currentBottomList=
[];this.updateLongestItem=function(){b.longestItem=null;for(var d=y=0;d<b.currentList.length;d++){var a=b.currentList[d];if(a[b.options.dataFields.text]){var c=a[b.options.dataFields.text].length;0<b.options.indent&&(c+=b.indentList[d]/b.options.indent);y<c&&(y=c,b.longestItem=a)}}};var A=function(d,a,c,u,e){d.type="item";d[b.options.dataFields.id]||(d[b.options.dataFields.id]=g.getUniqueId());c&&(d[b.options.dataFields.pid]=c);if(c=J(d))if(u)b.fullList.push(d);else{u=a;0!=b.options.showStatusIcons&&
(u+=15);switch(d[b.options.dataFields.fixed]){case "top":b.currentTopList.push(d);break;case "bottom":b.currentBottomList.push(d);break;default:b.currentList.push(d),b.indentList.push(u),b.parentList.push({parent:e})}d[b.options.dataFields.text]&&(e=d[b.options.dataFields.text].length,0<b.options.indent&&(e+=a/b.options.indent),0!=b.options.showStatusIcons&&(e+=15),y<e&&(y=e,b.longestItem=d))}return c};this.isThereVisibleChildren=function(d){var a=!1;if(d&&(d=d[b.options.dataFields.items]))for(var c=
0;c<d.length;c++)if(J(d[c])&&!b.isItemFixed(d[c])){a=!0;break}return a};this.isItemFixed=function(d){return"top"==d[b.options.dataFields.fixed]||"bottom"==d[b.options.dataFields.fixed]?!0:!1};this.isThereChildItems=!1;var N=function(d,a,c,u,e){if(!d[b.options.dataFields.items])return c=A(d,a,c,u,e);if((c=A(d,a,c,u,e))&&!b.isItemFixed(d)){e=0;var l;if(u||b.isItemExpanded(d)||b.isItemFixed(d)&&d[b.options.dataFields.fixChildren]){var t=d[b.options.dataFields.items];if(t){b.applySorting(t);for(var g=
...
!0;break}h=a.sourceCollection.getParent(h)}g||t.push(a.source[u])}if(0<t.length)if(d=t[t.length-1],u=a.sourceCtrl.getObjCurrentIndex(t[0]),g=a.sourceCtrl.getObjCurrentIndex(d),u<=g)for(u=0;u<t.length;u++)B(t[u],a);else for(u=t.length-1;0<=u;u--)B(t[u],a)}else B(a.source,a);a.sourceCtrl!==b?(b.allowUpdate=!0,a.sourceCtrl.allowUpdate=!0,b.updateCurrentLayout(),a.sourceCtrl.updateCurrentLayout()):(b.allowUpdate=!0,b.updateCurrentLayout());b.updateAutoLayout();a.sourceCtrl.multiSelection(!1);var k=e(function(){if(d){a.sourceCtrl.clearPrevSelection(d);
...
c.beforeSelect({e:{item:l}});b.selectionCancelled=0==h;if(0!=h)if(t){var k=a&&(a.shiftKey||a.ctrlKey||a.metaKey)?!0:!1,t=!0;"multi-extended"===b.options.selectionMode&&(t=!b.isObjInSelList(l)||!k);t&&("one"==b.options.selectionMode?b.clearPrevSelection():oa&&(E||a&&a.shiftKey)?b.clearPrevSelection():U||k||"multi-simple"===b.options.selectionMode||k||1!=b.options.selectedItems.length&&b.isObjInSelList(l)||b.clearPrevSelection());b.options.selectedItem=l;if(oa&&(E||a&&a.shiftKey)&&"one"!=b.options.selectionMode){if(a=
...
sourceTree:p.sourceCtrl?p.sourceCtrl.getCtrlName():"",dragItem:e,targetTree:a.getCtrlName(),targetItem:f,isDropAllowed:d,dropPos:p.dropPos,mousePos:a.getMousePos(b)},!1!==a.callDragDrop(d)&&(a.drop(p),h.$$phase||h.$apply()))}}n.clearData();a.dragDropStatus(!1);b.stopPropagation()},E=angular.element('<div style="opacity:0.75;position:absolute;z-index:999"></div>'),U=function(){E&&(E.remove(),E.css("top","-9999999px"),E.css("left","-9999999px"))},Ja=function(b){var c="";if(a.options.showExpandBoxes){var d=
...
0<f.length){va=xa({x:f[0].pageX,y:f[0].pageY});var f=Math.abs(va.x-Ya.x),r=Math.abs(va.y-Ya.y),e=m[0].getBoundingClientRect();if(n.hitTest(va.x,va.y,e)){if(b.preventDefault(),E&&E.css("display","block"),!ib)if(!wa&&(2<f||2<r)&&ca&&a.isItemEnabled(ca))if(angular.element(this),a.labelEditStatus())b.preventDefault();else{wa=!0;n.clearData();if((f=a.getTouchData(b))&&0<f.length&&(xa({x:f[0].pageX,y:f[0].pageY}),ca&&(ab(),a.isDragAllowed(ca)))){a.dragDropStatus(!0);a.addDropMark();f={source:ca,sourceCtrl:a,
sourceCollection:a.dataObj};switch(a.options.selectionMode){case "multi-simple":f.source=a.options.selectedItems;break;case "multi-extended":f.source=a.options.selectedItems}n.setData(f);if(f=a.getElemFromItem(ca))if(f=a.getElement(f))E.empty(),E.append(f.clone()),E.css("display","none"),m.append(E)}b.stopPropagation()}else if(wa){angular.element(this);a.labelEditStatus()&&a.closeEditor();b.preventDefault();if((f=a.getTouchData(b))&&0<f.length){var e=jb(),p=xa({x:f[0].pageX,y:f[0].pageY});if(f=a.getItemAt(p.x,
p.y)){if(r=a.getElemFromItem(f)){var D=r[0].getBoundingClientRect(),D=n.getDropPos({x:p.x-D.left,y:p.y-D.top},{x:0,y:0,width:r[0].offsetWidth,height:r[0].offsetHeight}),r=n.getData(),g=a.isDropAllowed(r.source,f,D),k={event:b,sourceTree:r.sourceCtrl?r.sourceCtrl.getCtrlName():"",dragItem:r.source,targetTree:a.getCtrlName(),targetItem:f,isDropAllowed:g,dropPos:D,mousePos:p},k=a.callDragOver(k);d=m[0].getBoundingClientRect();c=p.x-d.left;d=p.y-d.top;E.css("top",d-16+"px");E.css("left",c+"px");E.css("display",
"block");if(g&&0!=k){c=p;p=c.y+e.y+16;e=c.x+e.x+20;c=a.getDropMarkWindow();c.empty();d="iui-drop-marker-move-in";switch(D){case 1:d="iui-drop-marker-move-up";break;case 2:d="iui-drop-marker-move-down"}c.append("<span class='"+d+"'></span><span class='iui-drop-marker-title'>"+f[a.options.dataFields.text]+"</span>");a.updateDropMarkElem(a.getDropMarkWindow(),{top:p,left:e});a.dropMark(g);n.setData({source:r.source,sourceList:r.sourceList,target:f,dropPos:D})}else a.dropMark()}}else f=n.getData(),r=
{source:f.source,sourceCtrl:f.sourceCtrl,target:null,dropPos:-1},n.setData(r),k={event:b,sourceTree:f.sourceCtrl?f.sourceCtrl.getCtrlName():"",dragItem:f.source,targetTree:a.getCtrlName(),targetItem:null,isDropAllowed:a.options.allowDrop,dropPos:-1,mousePos:p},d=m[0].getBoundingClientRect(),c=p.x-d.left,d=p.y-d.top,E.css("top",d-16+"px"),E.css("left",c+"px"),k=a.callDragOver(k),0==k?a.dropMark():(c=p,p=c.y+16,e=c.x+20,c=a.getDropMarkWindow(),c.empty(),c.append("<span class='iui-drop-marker-move-end'></span><span class='iui-drop-marker-title'>"+
(h.name?h.name:"TreeView")+"</span>"),a.updateDropMarkElem(a.getDropMarkWindow(),{top:p,left:e}),a.dropMark(!0))}b.stopPropagation()}}else b.preventDefault(),a.dropMark(),a.cancelScrollTimer(),E&&E.css("display","none")}});b.bind("touchend",function(b){var c=a.getItemFromChildElem(this);if(c&&a.isItemEnabled(c)){if((c=a.getTouchData(b))&&0<c.length){var c=xa({x:c[0].pageX,y:c[0].pageY}),d=m[0].getBoundingClientRect();if(n.hitTest(c.x,c.y,d))if(wa){angular.element(this);b.preventDefault();ya();a.dropMark();
...
ea&&(q.cancel(ea),ea=null)});var c=function(b,c){b.preventDefault();focusDelayTime=0;var d=a.getItemCurrentIndex(c),f=K+x-2,f=f<a.currentList.length-1?f:a.currentList.length-1;d===f&&(a.setScrollPos({x:a.scrollPos.x,y:a.scrollPos.y+Math.floor(m[0].clientHeight/4)}),focusDelayTime=1);var r=a.getNextItem(d);if(r){a.itemSelection(b,r);h.$apply();var p=q(function(){a.updateFocus(r);q.cancel(p)},focusDelayTime)}},d=function(b,c){b.preventDefault();focusDelayTime=0;var d=a.getItemCurrentIndex(c),f=K;d===
...
d(f,p):k.isEqual(p[a.options.dataFields.id],a.currentList[e-1][a.options.dataFields.id])||c(f,p));break;case 13:Ma(f,b,0);break;case 16:a.updateSelectionStatus(f,"shift");break;case 17:a.updateSelectionStatus(f,"ctrl");break;case 33:f.preventDefault();e=a.getItemCurrentIndex(p);p=e-x;p=0<p?p:0;if(p!==e){var e=1,r=a.getPrevItem(p+1);if(r){a.scrollTo(r);a.itemSelection(f,r);h.$apply();var D=q(function(){a.updateFocus(r);q.cancel(D)},e)}}break;case 34:f.preventDefault();e=a.getItemCurrentIndex(p);p=
e+x;p=p<a.currentList.length-1?p:a.currentList.length-1;p!==e&&(e=1,r=a.getNextItem(p-1))&&(a.scrollTo(r,"bottom"),a.itemSelection(f,r),h.$apply(),D=q(function(){a.updateFocus(r);q.cancel(D)},e));break;case 35:f.preventDefault();a.setScrollPos({x:a.scrollPos.x,y:I.y});var g=a.getLastItem();g&&(a.itemSelection(f,g),D=q(function(){a.updateFocus(g);q.cancel(D)},1));break;case 36:f.preventDefault();a.setScrollPos({x:a.scrollPos.x,y:0});var l=a.getFirstItem();l&&(a.itemSelection(f,l),D=q(function(){a.updateFocus(l);
q.cancel(D)},1));break;case 37:f.preventDefault();p[a.options.dataFields.items]&&0<p[a.options.dataFields.items].length&&(a.toggle(p,!1),a.updateFocus(p));break;case 32:f.preventDefault();a.itemSelection(f,p,p.selected);h.$apply();break;case 38:d(f,p);break;case 39:f.preventDefault();p[a.options.dataFields.items]&&0<p[a.options.dataFields.items].length&&(a.toggle(p,!0),a.updateFocus(p));break;case 40:c(f,p);break;default:(f.ctrlKey||f.metaKey)&&a.updateSelectionStatus(f,"ctrl"),f.shiftKey&&a.updateSelectionStatus(f,
...
null;var I={x:0,y:0},Ra=0;h.verScrollVisibility=!1;h.$watch("verScrollVisibility",function(b,c){b!=c&&a.updateCurrentLayout()});a.updateViewSize=function(){var b=q(function(){P=0;F=G=!1;a.getTemplateUrl()||a.updateLongestItem();if(!a.getTemplateUrl()&&a.longestItem&&0<a.currentList.length){var c=a.getItemCurrentIndex(a.longestItem),c=angular.element(Rb(c,!0));m.append(c);P=c[0].offsetWidth;var d=m[0].offsetWidth-6;F&&y&&(d-=y[0].offsetWidth);P>d&&(A.unbind("click mousedown"),m.append(A),A.bind("click",
...
q(function(){var f=x;x+=a;lb();for(var e=0,p="";f<x;f++)p+=Wa(f),e++;0<e&&(C.append(c(p)(v)),za(),d());q.cancel(b)},1)};a.updateAutoLayout=function(){if(a.options.autoSize){var b=a.currentList.length*(z+(ha.top+ha.bottom)/2),b=b+(H[0].offsetHeight+J[0].offsetHeight);G&&A&&(b+=A[0].offsetHeight);m.css("height",b+"px")}};a.updateLayout=function(b){/*m.append(w.$tw);w.s1t(w.twp);*/b=!0;for(var c=m.parent();"body"!=c[0].tagName.toLowerCase();){if("none"==getComputedStyle(c[0]).display){b=!1;break}c=c.parent()}if(b&&
...
b[a.options.dataFields.pid]){c=!0;break}return c};var Hb=function(b,c,d,e,g){var f={top:0,left:0==a.options.rtl?c*a.options.indent+7:"auto",right:0!=a.options.rtl?c*a.options.indent+8:"auto",width:0,height:z},p=a.isTherePrevItem(b),h=a.isThereNextItem(b);e?(h||(f.height=Math.floor(z/2)),p||g||(f.height=Math.floor(z/2),f.top=Math.floor(z/2)),(p||h||g)&&d.push(f)):h&&d.push(f);e&&!a.isThereVisibleChildren(b)&&(f={width:8,height:0},f.top=Math.floor(z/2),f.left=0==a.options.rtl?c*a.options.indent+7:"auto",
...
else p=[];g=d?Ja(b):"";k=d&&!e?a.isItemEnabled(b)&&a.isDragAllowed(b):!1;l=d?wb(b):"";h=d?0!=a.options.showIcons&&yb(b):!1;e=d&&!e?a.indentList[c]:0;var r=d?xb(b):"",m=d?0!=a.options.showStatusIcons&&(b?b[a.options.dataFields.statusIcon]:!1):!1,n;n=d?1==a.options.allowFocus&&a.isItemEnabled(a.currentList[c])?a.getTabIndex().toString()+(c+1).toString():"":"";var q=a.getTemplateUrl(),D;if(d){D=a.getTemplateUrl();var t=a.currentList[c];D=D&&""!=D&&void 0!=t[a.options.dataFields.templateObj]&&null!=t[a.options.dataFields.templateObj]?
!0:!1}else D=!1;return{checkVisible:f,lines:p,expandBox:g,draggable:k,icon:l,iconVisible:h,indent:e,index:c,item:d?b:{},statusIcon:r,statusIconVisible:m,style:{},tabindex:n,templateUrl:q,templateVisible:D,updateContextMenu:d?null!=b[a.options.dataFields.contextMenu]:!1,visible:d}},Eb=function(){for(var b=[],c=K;c<K+x;c++)b.push(mb(a.currentList[c],c,c<a.currentList.length));return b},Fb=function(){for(var b=[],c=0;c<a.currentTopList.length;c++)b.push(mb(a.currentTopList[c],c,c<a.currentTopList.length,
