...
g)},removeColumnAt:function(f,g){c.$broadcast(f+"-remove-column-at",g)},addRow:function(f,g,t){c.$broadcast(f+"-add-row",g,t)},clearRows:function(f,g){c.$broadcast(f+"-clear-rows",g)},insertRowAt:function(f,g,t,n){c.$broadcast(f+"-insert-row-at",g,t,n)},insertRowBefore:function(f,g,t){c.$broadcast(f+"-insert-row-before",g,t)},insertRowAfter:function(f,g,t){c.$broadcast(f+"-insert-row-after",g,t)},removeRow:function(f,g){c.$broadcast(f+"-remove-row",g)},removeRowAt:function(f,g,t){c.$broadcast(f+"-remove-row-at",
g,t)},exportToJSON:function(f,g,t,n,e){c.$broadcast(f+"-export-json",g,t,n,e);f=this.getTempData();this.clearTempData();return f?f:""},loadData:function(f,g,e,n,ba){c.$broadcast(f+"-load-data",g,e,n,ba)},openEditor:function(f,g){c.$broadcast(f+"-open-editor",g)},closeEditor:function(f,g){c.$broadcast(f+"-close-editor",g)},collapse:function(f,g){c.$broadcast(f+"-collapse",g)},expand:function(f,g){c.$broadcast(f+"-expand",g)},expandColIndex:function(f,g){c.$broadcast(f+"-expand-col-index",g)},toggle:function(f,
...
general:"iui-treegrid-row-cell",disabled:"iui-treegrid-row-cell-disabled",focused:"iui-treegrid-row-cell-focused",normal:"iui-treegrid-row-cell",hovered:"iui-treegrid-row-cell-hovered",selected:"iui-treegrid-row-cell-selected"}};this.updatePaging=function(b){a.options.paging=b?{enabled:n.isFieldAvailable(b.enabled,!1),showControlPanel:n.isFieldAvailable(b.showControlPanel,!0),pageSize:n.isFieldAvailable(b.pageSize,100)}:{enabled:!1,showControlPanel:!0,pageSize:100}};this.updateOptions=function(b){b?
(a.options={allowAnimation:n.isFieldAvailable(b.allowAnimation,!0),allowCellFocus:n.isFieldAvailable(b.allowCellFocus,!0),allowColumnReorder:n.isFieldAvailable(b.allowColumnReorder,!1),allowDrag:n.isFieldAvailable(b.allowDrag,!1),allowDrop:n.isFieldAvailable(b.allowDrop,!0),allowFilter:n.isFieldAvailable(b.allowFilter,!1),allowFocus:n.isFieldAvailable(b.allowFocus,!0),animationSpeed:200,autoExpand:n.isFieldAvailable(b.autoExpand,!0),controlStyle:a.defaultStyle,editorSettings:{activate:"click"},enabled:n.isFieldAvailable(b.enabled,
!0),expandColIndex:n.isFieldAvailable(b.expandColIndex,void 0!=a.options.expandColIndex?a.options.expandColIndex:0),fillSpace:n.isFieldAvailable(b.fillSpace,!1),gridLines:n.isFieldAvailable(b.gridLines,"both"),hoverSelection:n.isFieldAvailable(b.hoverSelection,!1),indent:n.isFieldAvailable(b.indent,15),labelEdit:n.isFieldAvailable(b.labelEdit,!1),loadRows:[],pathSeparator:n.isFieldAvailable(b.pathSeparator,"\\"),rowHeight:n.isFieldAvailable(b.rowHeight,-1),rtl:n.isFieldAvailable(b.rtl,!1),selectedColumn:n.isFieldAvailable(b.selectedColumn,
a.options.selectedColumn?a.options.selectedColumn:null),selectedIndex:-1,selectedRow:n.isFieldAvailable(b.selectedRow,a.options.selectedRow?a.options.selectedRow:null),selectedRows:a.options.selectedRows?a.options.selectedRows:[],selectionMode:n.isFieldAvailable(b.selectionMode,"one"),showExpandBoxes:n.isFieldAvailable(b.showExpandBoxes,!0),showFooter:n.isFieldAvailable(b.showFooter,!0),showHeader:n.isFieldAvailable(b.showHeader,!0),showIcons:n.isFieldAvailable(b.showIcons,!0),sorting:n.isFieldAvailable(b.sorting,
...
"-remove-row",function(b,d){a.rowsObj.removeAt(d,-1,null,a.rowIsRemoved)});c.$on(c.name+"-remove-row-at",function(b,d,c){a.rowsObj.removeAt(null,d,c,a.rowIsRemoved)});this.rowsAreCleared=function(b){b||(a.clearPrevSelection(),a.options.selectedRow=null,a.setScrollPos({x:0,y:0}));a.updateCurrentLayout()};this.rowIsAdded=function(){a.updateCurrentLayout()};this.rowIsRemoved=function(b,d,c){a.updateCurrentLayout()};this.objIsRemoved=function(b,d,c){a.updateCurrentLayout()};a.columnList=[];a.columnFilterList=
[];a.isThereLeftFixedColumns=!1;a.isThereRightFixedColumns=!1;this.updateColumnList=function(){a.columnList.length=0;a.columnFilterList.length=0;a.isThereLeftFixedColumns=!1;a.isThereRightFixedColumns=!1;var b=a.columnsObj.getList();if(b)for(var d=0;d<b.length;d++){var c=b[d];c.type="column";c[a.options.columnFields.id]||(c[a.options.columnFields.id]=n.getUniqueId());if(0!=c[a.options.columnFields.visible]){var h=c[a.options.columnFields.filterParams],h=h?Wb.createTree(h.conditions,h.formula):null;
a.columnFilterList.push({cid:c[a.options.columnFields.id],tree:h});a.columnList.push(c);switch(c[a.options.columnFields.fixed]){case "left":a.isThereLeftFixedColumns||(a.isThereLeftFixedColumns=!0);break;case "right":a.isThereRightFixedColumns||(a.isThereRightFixedColumns=!0)}}}};var sc=function(b){for(var d=null,c=0;c<a.columnFilterList.length;c++)if(a.columnFilterList[c].cid==b){d=a.columnFilterList[c].tree;break}return d},A=function(b,d){if(0==a.options.allowFilter)return!0;var c=!0;if(b)for(var h,
u,e,f=0;f<b[a.options.rowFields.cells].length&&(c=!0,e=b[a.options.rowFields.cells][f],h=e[a.options.cellFields.cid],u=a.getColumnById(h),!u&&f<a.columnList.length&&(u=a.columnList[f]),u&&u[a.options.columnFields.filterParams]&&(c=u[a.options.columnFields.filterParams],u=e[a.options.cellFields.value]?e[a.options.cellFields.value]:e[a.options.cellFields.text],c=c.callback?c.callback(u,e,b):Wb.match(u,c.conditions,c.formula,sc(h))),c);f++);return c},X=a.options.indent;a.currentPageList=[];a.pageList=
[];a.onlyCurrentPage=!1;a.currentList=[];a.fullIndentList=[];a.fullList=[];a.indentList=[];a.longestRow=null;a.isThereChildRows=!1;a.pageRowCount=0;a.pageNumber=0;a.currentPageNumber=1;this.isThereVisibleChildren=function(b){var d=!1;if(b&&(b=b[a.options.rowFields.rows])&&0<b.length)for(var c=0;c<b.length;c++)if(A(b[c])){d=!0;break}return d};var J=function(b,d,c,h){b.type="row";b[a.options.rowFields.id]||(b[a.options.rowFields.id]=n.getUniqueId());c&&(b[a.options.rowFields.pid]=c);c=!0;var u=b[a.options.rowFields.cells];
if(u&&0<u.length){c=A(b,h);for(var e,f,g,k=0;k<a.columnList.length;k++){g=a.columnList[k];e=g[a.options.columnFields.id];f=g[a.options.columnFields.editorType];g=g[a.options.columnFields.editorSettings];var m=k;e&&(m=a.getCellIndexById(u,k,e));0<=m&&m<u.length&&(u[m].type="cell",u[m][a.options.cellFields.rid]=b[a.options.rowFields.id],a.setDefaultCellValue(u[m],f,g))}}c&&(h?(a.fullList.push(b),a.fullIndentList.push(d)):a.options.paging.enabled?a.onlyCurrentPage?a.currentPageList.push({row:b,indent:d}):
(b[a.options.rowFields.pid]||a.pageRowCount++,a.pageRowCount>a.options.paging.pageSize&&(a.pageRowCount=1,a.pageNumber++,a.pageList.push([])),a.pageList[a.pageNumber].push({row:b,indent:d})):(a.currentList.push(b),a.indentList.push(d)));return c},v=function(b,d,c,h){if(!b[a.options.rowFields.rows])return c=J(b,d,c,h);if(c=J(b,d,c,h)){var u=0,e;if(h||a.isRowExpanded(b)){var f=b[a.options.rowFields.rows];if(f){a.applySorting(f);for(var g=0;g<f.length;g++)(e=v(f[g],d+X,b[a.options.rowFields.id],h))&&
u++}}h||a.isThereChildRows||!(0<u||!a.isRowExpanded(b)&&b[a.options.rowFields.rows]&&0<b[a.options.rowFields.rows].length&&a.isThereVisibleChildren(b))||(a.isThereChildRows=!0)}return c};this.getFullList=function(){a.fullList.length=0;a.fullIndentList.length=0;for(var b=a.rowsObj.getList(),d=0;d<b.length;d++)v(b[d],0,null,!0);return a.fullList};this.getCurrentList=function(){return a.currentList};this.updateCurrentList=function(){a.currentList.length=0;a.indentList.length=0;X=a.options.indent;if(a.options.paging.enabled){if(1<=
a.currentPageNumber&&a.currentPageNumber<=a.pageList.length)for(var b=0;b<a.pageList[a.currentPageNumber-1].length;b++)a.currentList.push(a.pageList[a.currentPageNumber-1][b].row),a.indentList.push(a.pageList[a.currentPageNumber-1][b].indent)}else{a.isThereChildRows=!1;var d=a.rowsObj.getList();if(d)for(a.applySorting(d),b=0;b<d.length;b++)v(d[b],0,null,!1)}};this.updateCurrentPageList=function(){a.currentPageList.length=0;a.isThereChildRows=!1;a.onlyCurrentPage=!0;X=a.options.indent;if(1<a.currentPageNumber){var b=
a.pageList[a.currentPageNumber-1];if(b&&0<b.length){a.applySorting(b);for(var d=0;d<b.length;d++)v(b[d],0,null,!1)}a.pageList[a.currentPageNumber-1]=a.currentPageList}a.onlyCurrentPage=!1};this.updatePageList=function(){a.pageList.length=0;a.pageRowCount=0;a.pageNumber=0;a.isThereChildRows=!1;X=a.options.indent;var b=a.rowsObj.getList();if(b&&0<b.length){a.applySorting(b);a.pageList.push([]);for(var d=0;d<b.length;d++)v(b[d],0,null,!1);0<a.pageList.length&&0==a.pageList[a.pageList.length-1].length&&
a.pageList.splice(a.pageList.length-1,1)}};this.columnEvents={clear:function(a){return angular.isDefined(c.events)&&c.events.clearColumns?c.events.clearColumns({parent:a.e.parent}):c.clearColumns(a)},objAdded:function(a){return angular.isDefined(c.events)&&c.events.columnAdded?c.events.columnAdded({column:a.e.column}):c.columnAdded(a)},objAdding:function(a){return angular.isDefined(c.events)&&c.events.rowAdding?c.events.columnAdding({column:a.e.column}):c.columnAdding(a)},objRemoved:function(a){return angular.isDefined(c.events)&&
...
subobjects:a.cells?a.cells:"cells",text:a.text?a.text:"text"}};a.columnsObj=new ba({objects:c.columns,events:a.columnEvents,fields:a.options.columnFields});a.rowsObj=new ba({objects:c.rows,events:a.rowEvents,fields:a.getRowFields(a.options.rowFields)});c.$on(c.name+"-load-data",function(b,d,c,h,u){a.loadData(d,c,h,u)});c.$on(c.name+"-export-json",function(b,d,c,h,u){k.setTempData(a.exportToJSON(d,c,h,u))});this.exportToJSON=function(b,d,c,h){var u=h,u=u?u:null,e=a.columnsObj.getList();b=JSON.stringify(e,
b?b:[a.options.columnFields.allowDrag,a.options.columnFields.allowDrop,a.options.columnFields.allowFilter,a.options.columnFields.cellTemplateUrl,a.options.columnFields.contentAlignment,a.options.columnFields.contextMenu,a.options.columnFields.editorType,a.options.columnFields.editorSettings,a.options.columnFields.editorTemplate,a.options.columnFields.filterParams,a.options.columnFields.filterTemplate,a.options.columnFields.fixed,a.options.columnFields.fixedWidth,a.options.columnFields.footerAlignment,
a.options.columnFields.footerContent,a.options.columnFields.footerTemplate,a.options.columnFields.footerTooltip,a.options.columnFields.footerText,a.options.columnFields.headerAlignment,a.options.columnFields.headerContent,a.options.columnFields.headerTemplate,a.options.columnFields.headerText,a.options.columnFields.headerTooltip,a.options.columnFields.icon,a.options.columnFields.id,a.options.columnFields.style,a.options.columnFields.templateSettings,a.options.columnFields.visible,a.options.columnFields.width],
u);h=h?h:null;u=!1!==c?a.getFullList():a.rowsObj.getList();d=d?d:[a.options.rowFields.allowCellFocus,a.options.rowFields.allowDrag,a.options.rowFields.allowDrop,a.options.rowFields.allowFocus,a.options.rowFields.cells,a.options.rowFields.content,a.options.rowFields.contextMenu,a.options.rowFields.enabled,a.options.rowFields.expanded,a.options.rowFields.hasChildren,a.options.rowFields.icon,a.options.rowFields.id,a.options.rowFields.pid,a.options.rowFields.statusIcon,a.options.rowFields.style,a.options.rowFields.text,
a.options.rowFields.tooltip,a.options.cellFields.rid];0==c&&d.push(a.options.rowFields.rows);c=JSON.stringify(u,d,h);return'[\n{ "columns": '+b+' },\n{ "rows": '+c+" }\n]"};this.loadData=function(b,d,G,h){a.suspendLayout();a.updateDataFields(G);var u=[],e=a.options.rowFields;a.rowsObj.clear(d,a.rowsAreCleared);if(b)if(!1!==h){var f=[];b.forEach(function(a,b){var d=a[e.pid];f[d]?(f[d][e.rows]||(f[d][e.rows]=[]),f[a[e.id]]=a,f[d][e.rows].push(a)):(f[a[e.id]]=a,u.push(a))});f.length=0}else u=b;if(d)for(d[a.options.rowFields.rows]=
u,b=0;b<d[a.options.rowFields.rows].length;b++)d[a.options.rowFields.rows][b][a.options.rowFields.pid]=d[a.options.rowFields.id];else if(angular.isDefined(c.rows))for(b=c.rows.length=0;b<u.length;b++)c.rows.push(u[b]);a.rowsObj=new ba({objects:c.rows,events:a.rowEvents,fields:a.getRowFields(a.options.rowFields)});a.resumeLayout()};this.updateData=function(){a.options.rowFields.dataSource&&(a.loadData(a.options.rowFields.dataSource),a.rowsObj=new ba({objects:c.rows,events:a.rowEvents,fields:a.getRowFields(a.options.rowFields)}))};
var xa=!1;this.dragDropStatus=function(a){if(void 0!=a)xa=a;else return xa};this.getDnDSource=function(a){return{text:a.dataTransfer?a.dataTransfer.getData("text"):a.originalEvent.dataTransfer?a.originalEvent.dataTransfer.getData("text"):""}};this.getTouchData=function(a){return a.changedTouches?a.changedTouches:a.originalEvent?a.originalEvent.changedTouches:null};var Ga=angular.element('<div class="iui-drop-marker" data-element="dropmark"></div>');this.getDropMarkLine=function(){return dropMarkLine};
angular.element(g).bind("dragenter",function(b){a.dropMark()});angular.element(g).bind("dragend",function(b){a.removeDropMark();a.dragIcon&&angular.element(a.dragIcon).remove();a.cancelScrollTimer();a.dragDropStatus(!1)});a.getMousePos=function(a){return{x:a.pageX?a.pageX:a.originalEvent?a.originalEvent.pageX:0,y:a.pageY?a.pageY:a.originalEvent?a.originalEvent.pageY:0}};this.getCtrlName=function(){return angular.isDefined(c.name)?c.name:""};e.bind("dragenter",function(b){b.preventDefault();if(a.options.enabled){var d=
m.getData();d.source||(d.source=a.getDnDSource(b));b={event:b,sourceTree:d.sourceCtrl?d.sourceCtrl.getCtrlName():"",dragRow:d.source,targetTree:a.getCtrlName(),targetRow:d.target,mousePos:a.getMousePos(b)};a.callDragEnter(b)}});e.bind("dragover",function(b){b.preventDefault();if(a.options.enabled&&a.isDropInRange(b)){var d=!0;b.dataTransfer?d="none"===b.dataTransfer.effectAllowed?!1:!0:b.originalEvent&&b.originalEvent.dataTransfer&&(d="none"===b.originalEvent.dataTransfer.effectAllowed?!1:!0);if(d)if(b.dataTransfer?
b.dataTransfer.dropEffect=a.options.allowDrop?"move":"none":b.originalEvent&&b.originalEvent.dataTransfer&&(b.originalEvent.dataTransfer.dropEffect=a.options.allowDrop?"move":"none"),d=m.getData(),d.source||(d.source=a.getDnDSource(b)),m.setData({source:d.source,sourceCtrl:d.sourceCtrl,target:null,dropPos:-1}),d={event:b,sourceTree:d.sourceCtrl?d.sourceCtrl.getCtrlName():"",dragRow:d.source,targetTree:a.getCtrlName(),targetRow:null,isDropAllowed:a.options.allowDrop,dropPos:-1,mousePos:a.getMousePos(b)},
0==a.callDragOver(d))b.dataTransfer?b.dataTransfer.dropEffect="none":b.originalEvent&&b.originalEvent.dataTransfer&&(b.originalEvent.dataTransfer.dropEffect="none"),a.dropMark();else{d=a.getMousePos(b);b=d.y+16;var d=d.x+20,G=a.getDropMarkWindow();G.empty();G.append("<span class='iui-drop-marker-move-end'></span><span class='iui-drop-marker-title'>"+(c.name?c.name:"TreeGrid")+"</span>");a.updateDropMarkElem(a.getDropMarkWindow(),{top:b,left:d});a.dropMark(!0)}}else a.dropMark(),b.dataTransfer?b.dataTransfer.dropEffect=
"none":b.originalEvent&&b.originalEvent.dataTransfer&&(b.originalEvent.dataTransfer.dropEffect="none")});e.bind("drop",function(b){b.preventDefault();if(a.options.enabled){a.dropMark();if(a.isDropInRange(b)){var d=!0;b.dataTransfer?d="none"===b.dataTransfer.effectAllowed?!1:!0:b.originalEvent&&b.originalEvent.dataTransfer&&(d="none"===b.originalEvent.dataTransfer.effectAllowed?!1:!0);if(d&&(d=m.getData(),d.source||(d.source=a.getDnDSource(b)),d.source)){var G={event:b,sourceTree:d.sourceCtrl?d.sourceCtrl.getCtrlName():
"",dragRow:d.source,targetTree:a.getCtrlName(),targetRow:null,isDropAllowed:a.options.allowDrop,dropPos:-1,mousePos:a.getMousePos(b)};!1!==a.callDragDrop(G)&&(a.drop(d),c.$$phase||c.$apply())}}m.clearData()}b.stopPropagation()});e.bind("dragleave",function(b){b.preventDefault();if(a.options.enabled){a.dropMark();var d=m.getData();d.source||(d.source=a.getDnDSource(b));b={event:b,sourceTree:d.sourceCtrl?d.sourceCtrl.getCtrlName():"",dragRow:d.source,targetTree:a.getCtrlName(),targetRow:d.target,mousePos:a.getMousePos(b)};
a.callDragLeave(b)}a.cancelScrollTimer()});e.bind("dragend",function(b){b.preventDefault();a.options.enabled&&(a.dropMark(),m.getData().source||m.clearData(),a.dragDropStatus(!1))});e.bind("mouseleave",function(b){b.preventDefault();a.options.enabled&&(a.dropMark(),a.hoverColumn=null,a.hoverRow=null,a.hoverCell=null)});this.containsMousePos=function(a,d){return m.hitTest(a,d,{left:0,top:0,right:e[0].clientWidth,bottom:e[0].clientHeight})};this.isPopupActive=function(){return!1};var ya=function(b,
d){var c=a.options.rowFields;if(!b[c.cells]){b[c.cells]=[];var h={};h[a.options.cellFields.text]=b[d.text];b[c.cells].push(h)}b[c.rows]||(b[c.rows]=[]);b[c.rows].length=0;if(b[d.items]&&0<b[d.items].length)for(h=0;h<b[d.items].length;h++)b[c.rows].push(ya(b[d.items][h],d));return b},za=function(b,d){var c=!1;d.sourceCtrl&&(c=d.sourceCollection.removeAt(b,-1,null,d.sourceCtrl.objIsRemoved));c&&("item"==b.type&&(b=ya(b,d.sourceCtrl.options.dataFields)),0===d.dropPos?a.rowsObj.insertAt(b,-1,d.target,
a.rowIsAdded):1===d.dropPos||2===d.dropPos?1===d.dropPos?a.rowsObj.insertByRef(b,d.target,!1,a.rowIsAdded):a.rowsObj.insertByRef(b,d.target,!0,a.rowIsAdded):a.rowsObj.insertAt(b,-1,null,a.rowIsAdded))};this.setDropSelection=function(b,d){var c=b;!c&&0<=d&&d<a.currentList.length&&(c=a.currentList[d]);a.clearPrevSelection(c);a.rowSelection(c)};this.drop=function(b){if(b&&b.sourceCtrl){b.sourceCtrl.suppressProcess=!0;a.allowUpdate=!1;b.sourceCtrl.allowUpdate=!1;var d=b.source,c=-1;if(Array.isArray(b.source)){0<
b.source.length&&(c=b.sourceCtrl.getObjCurrentIndex(b.source[b.source.length-1]));for(var h=[],e=0;e<b.source.length;e++){for(var g=!1,k=b.sourceCollection.getParent(b.source[e]);k;){if(b.sourceCtrl.isObjInSelList(k)){g=!0;break}k=b.sourceCollection.getParent(k)}g||h.push(b.source[e])}if(0<h.length)if(d=h[h.length-1],e=b.sourceCtrl.getObjCurrentIndex(h[0]),g=b.sourceCtrl.getObjCurrentIndex(d),e<=g)for(e=0;e<h.length;e++)za(h[e],b);else for(e=h.length-1;0<=e;e--)za(h[e],b)}else c=b.sourceCtrl.getObjCurrentIndex(b.source),
za(b.source,b);b.sourceCtrl!==a?(a.allowUpdate=!0,b.sourceCtrl.allowUpdate=!0,a.updateCurrentLayout(),b.sourceCtrl.updateCurrentLayout()):(a.allowUpdate=!0,a.updateCurrentLayout());b.sourceCtrl.multiSelection(!1);var n=f(function(){b.sourceCtrl!==a&&b.sourceCtrl.setDropSelection(null,c);a.setDropSelection(d);a.updateFocus(a.getObjCurrentIndex(d),0);f.cancel(n)},1);b.sourceCtrl.suppressProcess=!1}};this.isDragAllowed=function(b){return a.options.allowDrag?b&&(b[a.options.rowFields.allowDrag]||void 0===
b[a.options.rowFields.allowDrag])?!0:!1:!1};this.isChildOf=function(b,d){var c=!1;if(b&&d){var h=d[a.options.rowFields.rows];if(h&&0<h.length)for(var e=0;e<h.length;e++){if(n.isEqual(b[a.options.rowFields.id],h[e][a.options.rowFields.id])){c=!0;break}else c=a.isChildOf(b,h[e]);if(c)break}}return c};this.isParentOf=function(b,d){var c=a.rowsObj.getParent(d);return b&&d&&c&&n.isEqual(b[a.options.rowFields.id],c[a.options.rowFields.id])?!0:!1};this.isDropAllowed=function(b,d,c){var h=a.options.allowDrop;
if(h&&b&&d&&(h=d[a.options.rowFields.allowDrop]||void 0===d[a.options.rowFields.allowDrop]?!0:!1))if(Array.isArray(b))for(var e=0;e<b.length;e++){if(n.isEqual(b[e][a.options.rowFields.id],d[a.options.rowFields.id])||0===c&&a.isParentOf(d,b[e])||a.isChildOf(d,b[e])){h=!1;break}if(!h)break}else if(n.isEqual(b[a.options.rowFields.id],d[a.options.rowFields.id])||0===c&&a.isParentOf(d,b)||a.isChildOf(d,b))h=!1;return h};this.getDropMarkWindow=function(){for(var a=Ga,d=angular.element(document.body).children(),
c=0;c<d.length;c++){var h=angular.element(d[c]);if(h[0].attributes&&h[0].attributes["data-element"]&&"dropmark"===h[0].attributes["data-element"].value){a=h;break}}return a};this.dropMark=function(b,d){d||(d=a.getDropMarkWindow());if(d){var c="none";this.options.allowDrop&&(c=b?"block":"none");angular.element(d).css("display",c)}};this.updateDropMarkElem=function(a,d){a&&d&&(a.css("top",d.top+"px"),a.css("left",d.left+"px"),a.css("width",d.width+"px"))};c.$on(c.name+"-open-editor",function(b,d){a.openEditor(d)});
c.$on(c.name+"-close-editor",function(b,d){a.closeEditor(d)});this.updateEditorSettings=function(b){a.options.editorSettings=b?{activate:n.isFieldAvailable(b.activate,"click")}:{activate:"click"}};this.allowEvents=!0;this.callAfterCollapse=function(a){angular.isDefined(c.events)&&c.events.afterCollapse&&c.events.afterCollapse({row:a});c.afterCollapse({e:{row:a}})};this.callAfterExpand=function(a){angular.isDefined(c.events)&&c.events.afterExpand&&c.events.afterExpand({row:a});c.afterExpand({e:{row:a}})};
...
function(a){return angular.isDefined(c.events)&&c.events.beforeLabelEdit?c.events.beforeLabelEdit({cell:a}):c.beforeLabelEdit({e:{cell:a}})};this.callCellValueChanging=function(b,d,G){var h=!0;a.allowEvents&&(h=angular.isDefined(c.events)&&c.events.cellvalueChanging?c.events.cellvalueChanging({row:b,cell:d,value:G}):c.cellvalueChanging({e:{row:b,cell:d,value:G}}));return h};this.callCellValueChanged=function(b,d,G){a.allowEvents&&(angular.isDefined(c.events)&&c.events.cellvalueChanged?c.events.cellvalueChanged({row:b,
cell:d,value:G}):c.cellvalueChanged({e:{row:b,cell:d,value:G}}))};this.callChange=function(){angular.isDefined(c.events)&&c.events.change?c.events.change():c.change()};this.callColumnClick=function(a,d){angular.isDefined(c.events)&&c.events.columnClick&&c.events.columnClick({column:a,mousePos:d});c.columnClick({e:{column:a,mousePos:d}})};this.callColumnDblClick=function(a,d){angular.isDefined(c.events)&&c.events.columnDblclick&&c.events.columnDblclick({column:a,mousePos:d});c.columnDblclick({e:{column:a,
mousePos:d}})};this.callColumnHover=function(a){angular.isDefined(c.events)&&c.events.columnHover&&c.events.columnHover({column:a});c.columnHover({e:{column:a}})};this.callColumnPosChanging=function(a,d){return angular.isDefined(c.events)&&c.events.columnPoschanging?c.events.columnPoschanging({sourceColumn:a,targetColumn:d}):c.columnPoschanging({e:{sourceColumn:a,targetColumn:d}})};this.callColumnPosChanged=function(a,d){angular.isDefined(c.events)&&c.events.columnPoschanged&&c.events.columnPoschanged({sourceColumn:a,
...
c.events.dragEnter({event:a.event,sourceTree:a.sourceTree,dragRow:a.dragRow,targetTree:a.targetTree,targetRow:a.targetRow,mousePos:a.mousePos}):c.dragEnter({e:{event:a.event,sourceTree:a.sourceTree,dragRow:a.dragRow,targetTree:a.targetTree,targetRow:a.targetRow,mousePos:a.mousePos}})};this.callDragOver=function(b){var d=a.getCellAt(b.mousePos.x,b.mousePos.y);return angular.isDefined(c.events)&&c.events.dragOver?c.events.dragOver({event:b.event,sourceTree:b.sourceTree,dragRow:b.dragRow,targetTree:b.targetTree,
targetRow:b.targetRow,targetCell:d,isDropAllowed:b.isDropAllowed,dropPos:b.dropPos,mousePos:b.mousePos}):c.dragOver({e:{event:b.event,sourceTree:b.sourceTree,dragRow:b.dragRow,targetTree:b.targetTree,targetRow:b.targetRow,targetCell:d,isDropAllowed:b.isDropAllowed,dropPos:b.dropPos,mousePos:b.mousePos}})};this.callDragDrop=function(b){var d=a.getCellAt(b.mousePos.x,b.mousePos.y);return angular.isDefined(c.events)&&c.events.dragDrop?c.events.dragDrop({event:b.event,sourceTree:b.sourceTree,dragRow:b.dragRow,
...
targetRow:a.targetRow,mousePos:a.mousePos}):c.dragLeave({e:{event:a.event,sourceTree:a.sourceTree,dragRow:a.dragRow,targetTree:a.targetTree,targetRow:a.targetRow,mousePos:a.mousePos}})};this.callCellClick=function(a,d,G,h){angular.isDefined(c.events)&&c.events.cellClick&&c.events.cellClick({event:a,row:d,cell:G,mousePos:h});c.cellClick({e:{event:a,row:d,cell:G,mousePos:h}})};this.callCellHover=function(a,d){angular.isDefined(c.events)&&c.events.cellHover?c.events.cellHover({event:a,cell:d}):c.cellHover({e:{event:a,
cell:d}})};this.callEnabledChanged=function(a){angular.isDefined(c.events)&&c.events.enabledChanged?c.events.enabledChanged({enabled:a}):c.enabledChanged({e:{enabled:a}})};this.callRowClick=function(a,d,G){angular.isDefined(c.events)&&c.events.rowClick?c.events.rowClick({event:a,row:d,mousePos:G}):c.rowClick({e:{event:a,row:d,mousePos:G}})};this.callRowDblClick=function(a,d){return angular.isDefined(c.events)&&c.events.rowDblClick?c.events.rowDblClick({row:a,mousePos:d}):c.rowDblclick({e:{row:a,mousePos:d}})};
...
c.events.keyPress?c.events.keyPress({event:a,row:d}):c.keyPress({e:{event:a,row:d}})};this.callKeyUp=function(a,d){angular.isDefined(c.events)&&c.events.keyUp?c.events.keyUp({event:a,row:d}):c.keyUp({e:{event:a,row:d}})};this.callScrollPosChanged=function(){angular.isDefined(c.events)&&c.events.scrollPosChanged?c.events.scrollPosChanged({scrollPos:a.scrollPos}):c.scrollposChanged({e:{scrollPos:a.scrollPos}})};e.bind("click",function(b){a.options.enabled&&1===b.which&&a.callRowClick(b,null,a.getMousePos(b))});
e.bind("dblclick",function(b){b.preventDefault();a.options.enabled&&1===b.which&&a.callRowDblClick(null,a.getMousePos(b));b.stopPropagation()});e.bind("mousedown",function(b){a.options.enabled&&3===b.which&&a.callRowRightClick(null,a.getMousePos(b));a.removeDropDownList();a.closeFilterWindow();a.closeEditor();b.stopPropagation()});this.expandList=[];this.expandIndentList=[];var qb=function(b,d,c){b.type="row";b[a.options.rowFields.id]||(b[a.options.rowFields.id]=n.getUniqueId());c&&(b[a.options.rowFields.pid]=
c);c=!0;var h=b[a.options.rowFields.cells];if(h&&0<h.length){c=A(b);for(var e,f,g,k=0;k<a.columnList.length;k++){g=a.columnList[k];e=g[a.options.columnFields.id];f=g[a.options.columnFields.editorType];g=g[a.options.columnFields.editorSettings];var m=k;e&&(m=a.getCellIndexById(h,k,e));0<=m&&m<h.length&&(h[m].type="cell",a.setDefaultCellValue(h[m],f,g))}}c&&(a.expandList.push(b),a.expandIndentList.push(d));return c},B=function(b,d,c){if(!b[a.options.rowFields.rows])return c=qb(b,d+X,c);if(c=qb(b,d+
X,c)){var h=0,e;if(a.isRowExpanded(b)){var f=b[a.options.rowFields.rows];if(f){a.applySorting(f);for(var g=0;g<f.length;g++)(e=B(f[g],d+X,b[a.options.rowFields.id]))&&h++}}!a.isThereChildRows&&(0<h||!a.isRowExpanded(b)&&b[a.options.rowFields.rows]&&0<b[a.options.rowFields.rows].length&&a.isThereVisibleChildren(b))&&(a.isThereChildRows=!0)}return c};this.expand=function(b){a.expandList.length=[];a.expandIndentList.length=[];if(!a.isRowExpanded(b)){var d=a.getRowCurrentIndex(b);if(b=a.getList(b)){a.applySorting(b);
for(var c=0;c<b.length;c++)B(b[c],a.indentList[d],null)}if(0<a.expandList.length){a.allowEvents=!1;d++;Array.prototype.splice.apply(a.currentList,[d,0].concat(a.expandList));Array.prototype.splice.apply(a.indentList,[d,0].concat(a.expandIndentList));a.getRowScope()?a.updateView():a.updateLayout();var h=f(function(){a.updateViewSize();a.updateViewSize();a.updateScrollVisibility();a.updateScrollView();f.cancel(h);a.allowEvents=!0},1)}}};this.collapse=function(b){a.expandList.length=[];a.expandIndentList.length=
[];if(a.isRowExpanded(b)){var d=null,c=!1,h=b,e=-1,g=a.getRowCurrentIndex(b);for(b=a.getParent(b);b&&!c;){d=a.getList(b);for(e=d.indexOf(h)+1;!c&&e<d.length;)h=d[e],0<a.getRowCurrentIndex(h)&&(c=!0),e++;c||(h=b);b=a.getParent(b)}if(!c&&h)for(d=a.getList(),e=d.indexOf(h)+1;e<d.length;)if(h=d[e],0<a.getRowCurrentIndex(h)){c=!0;break}else e++;g++;d=a.currentList.length-g;c&&(d=a.getRowCurrentIndex(h)-g);if(0<d){a.currentList.splice(g,d);a.indentList.splice(g,d);a.getRowScope()?a.updateView():a.updateLayout();
var k=f(function(){a.updateViewSize();a.updateViewSize();a.updateScrollVisibility();a.updateScrollView();f.cancel(k);a.allowEvents=!0},1)}}};this.toggle=function(b,d){if(b){if(b[a.options.rowFields.hasChildren]||b[a.options.rowFields.rows]&&0!=b[a.options.rowFields.rows].length)if(!d||0==b[a.options.rowFields.expanded])if(!1!==d||0!=b[a.options.rowFields.expanded]){a.updateType="view";var c=void 0!==d?d:!1!==b[a.options.rowFields.expanded]?!0:!1;!1!==(void 0!==d?d?a.callBeforeExpand(b):a.callBeforeCollapse(b):
c?a.callBeforeCollapse(b):a.callBeforeExpand(b))&&(c=void 0!=d?d:!c,c!=b[a.options.rowFields.expanded]&&(0!=c?a.expand(b):a.collapse(b),b[a.options.rowFields.expanded]=c),a.isRowExpanded(b)?a.callAfterExpand(b):a.callAfterCollapse(b))}}else{for(var c=a.getFullList(),h=0;h<c.length;h++)c[h][a.options.rowFields.expanded]=d;a.updateCurrentLayout()}};c.$on(c.name+"-collapse",function(b,d){a.toggle(d,!1)});c.$on(c.name+"-expand",function(b,d){a.toggle(d,!0)});c.$on(c.name+"-expand-col-index",function(b,
d){0<=d&&d<a.columnList.length&&(a.options.expandColIndex=d)});c.$on(c.name+"-toggle",function(b,d){a.toggle(d)});this.isFilteringAllowed=function(b){return b&&b[a.options.columnFields.allowFilter]};c.$on(c.name+"-filter",function(b,d,c){a.filter(d,c)});this.filter=function(b,d){if(b)b[a.options.columnFields.filterParams]=d;else for(var c=0;c<a.columnList.length;c++)a.columnList[c][a.options.columnFields.filterParams]=null;a.closeFilterWindow();a.updateCurrentLayout();a.callChange()};this.callGotFocus=
function(a,d,e,h,f){angular.isDefined(c.events)&&c.events.gotFocus?c.events.gotFocus({event:a,row:d,cell:e,edit:void 0!=h?!0:!1,editValue:f}):c.gotFocus({e:{event:a,row:d,cell:e,edit:void 0!=h?!0:!1,editValue:f}})};this.callLostFocus=function(a,d,e,h,f){angular.isDefined(c.events)&&c.events.lostFocus?c.events.lostFocus({event:a,row:d,cell:e,edit:void 0!=h?!0:!1,editValue:f}):c.lostFocus({e:{event:a,row:d,cell:e,edit:void 0!=h?!0:!1,editValue:f}})};this.getTabIndex=function(){return e[0].attributes&&
e[0].attributes.tabindex?e[0].attributes.tabindex.value:""};this.updateFocus=function(b,d){if(1==a.options.allowFocus)var c=f(function(){if(a.isRowIndexInRange(b)){var h="none";0<=d&&d<a.columnList.length&&(h=a.columnList[d][a.options.columnFields.fixed]);var g=a.getElemFromRow(a.currentList[b],h);g&&(1==a.options.allowCellFocus&&0<=d&&d<a.columnList.length?(h=a.getElemFromCell(b,d,h))&&h[0].focus():g[0].focus())}else e[0].focus();f.cancel(c)},5)};c.$on(c.name+"-focus",function(b,d){if(d){var c,h;
switch(d.type){case "row":c=a.getRowCurrentIndex(d);a.updateFocus(c);break;case "cell":c=a.getCellRowIndex(d),h=a.getCellColumnIndex(d),a.updateFocus(c,h)}}else a.updateFocus()});var Xa=!1;this.getCell=function(b,d){if(0<=b&&b<a.currentList.length){var c=a.currentList[b],h=a.getColumnRealIndex(d);0<=d&&d<a.columnList.length&&(h=a.getCellIndexById(c[a.options.rowFields.cells],d,a.columnList[d].id));if(c[a.options.rowFields.cells]&&0<=h&&h<c[a.options.rowFields.cells].length)return c[a.options.rowFields.cells][h]}return null};
this.getCellObject=function(b,d){if(0<=b&&b<a.currentList.length){var c=a.currentList[b],h=a.getColumnRealIndex(d);0<=d&&d<a.columnList.length&&(h=a.getCellIndexById(c[a.options.rowFields.cells],d,a.columnList[d].id));if(c[a.options.rowFields.cells]&&0<=h&&h<c[a.options.rowFields.cells].length)return c[a.options.rowFields.cells][h]}return null};this.getCellIndexById=function(b,d,c){var h=-1;if(b){d=a.getColumnRealIndex(d);for(var e=0;e<b.length;e++)if(void 0==b[e][a.options.cellFields.cid]){h=d;break}else if(b[e][a.options.cellFields.cid]==
...
var e,h,f=null;e="left";for(var g=0;!f&&3>g;){if(e=a.getHeaderElem(e)){var k=e.find("td");if(k&&0<k.length)for(var m=0;m<k.length;m++)if(e=angular.element(k[m]),h=n.getPageRect(e),n.checkHit(b,c,h)){f=a.getColumnFromElem(e);break}}g++;e=1==g?"right":"none"}return f};this.getCellAt=function(b,c){var e=null,h=a.getRowAt(b,c);if(h){var f,g,k=a.getElemFromRow(h).find("td");if(k&&0<k.length)for(var m=0;m<k.length&&!(f=angular.element(k[m]),g=n.getPageRect(f),n.checkHit(b,c,g)&&(e=a.getRowCurrentIndex(h),
f=a.getIndexFromElem(f),e=a.getCellObject(e,f)));m++);}return e};this.getRowAt=function(b,c){var e,f,g=null;e="none";for(var k=0;!g&&3>k;){var m=a.getRowElems(e);if(m&&0<m.length)for(var t=0;t<m.length;t++)if(e=angular.element(m[t]),f=n.getPageRect(e),n.checkHit(b,c,f)){g=a.getRowFromElem(e);break}k++;e=1==k?"left":"right"}return g};this.getRowCurrentIndex=function(b){return b&&a.currentList?a.currentList.indexOf(b):-1};this.getObjCurrentIndex=function(b){return a.getRowCurrentIndex(b)};this.getRowFromChildElem=
...
this.isRowIndexInRange=function(b){return 0<=b&&b<a.currentList.length};this.isColIndexInRange=function(b){return 0<=b&&b<a.columnList.length};this.isRowEnabled=function(b){return b&&1==a.options.enabled&&n.isEnabled(b[a.options.rowFields.enabled])};this.mouseButtonStatus=function(a){Xa=a};c.$on(c.name+"-ensure-visible",function(b,c){a.ensureVisible(c)});c.$on(c.name+"-find-row-by-id",function(b,c){k.setTempData(a.findRowById(c))});c.$on(c.name+"-find-row-by-path",function(b,c,e){k.setTempData(a.findRowByPath(c,
...
c].join(""),b=a.getParent(b);return c};this.getLevel=function(a){var c=0;for(a=this.getParent(a);a;)c++,a=this.getParent(a);return c};this.getParent=function(b){return a.rowsObj.getParent(b)};this.getList=function(b){return a.rowsObj.getList(b)};this.getFirstRow=function(){for(var b=null,c=0;c<a.currentList.length;c++)if(n.isEnabled(a.currentList[c][a.options.rowFields.enabled])){b=a.currentList[c];break}return b};this.getPrevRow=function(b){var c=null;if(0<=b&&b<a.currentList.length)for(--b;0<=b;b--)if(n.isEnabled(a.currentList[b][a.options.rowFields.enabled])){c=
a.currentList[b];break}return c};this.getNextRow=function(b){var c=null;for(b+=1;b<a.currentList.length;b++)if(n.isEnabled(a.currentList[b][a.options.rowFields.enabled])){c=a.currentList[b];break}return c};this.getLastRow=function(){for(var b=null,c=a.currentList.length-1;0<=c;c--)if(n.isEnabled(a.currentList[c][a.options.rowFields.enabled])){b=a.currentList[c];break}return b};this.updateSelectionStatus=function(b){switch(b){case "shift":switch(a.options.selectionMode){case "multi-simple":a.multiSelection(!0);
...
this.rowSelection=function(b,d,e,f,g){if(b){if("none"!=a.options.selectionMode)if(a.isRowEnabled(b)){var k=a.rowSelection(),m=!0;k&&(m=!n.isEqual(k[a.options.rowFields.id],b[a.options.rowFields.id]));var t=!0,t=angular.isDefined(c.events)&&c.events.beforeSelect?c.events.beforeSelect({object:b}):c.beforeSelect({e:{object:b}});if(!1!==t)if(m){var v=d||e||f?!0:!1,m=!0;"multi-extended"==a.options.selectionMode&&(m=!a.isObjInSelList(b));m&&("one"==a.options.selectionMode?a.clearPrevSelection():Xa&&d?a.clearPrevSelection():
pa||v||"multi-simple"===a.options.selectionMode||a.clearPrevSelection());a.options.selectedRow=b;if(Xa&&d&&"one"!=a.options.selectionMode){if(d=a.getRowCurrentIndex(k),g=a.getRowCurrentIndex(b),d>g&&(e=d,d=g,g=e),a.isRowIndexInRange(d)&&a.isRowIndexInRange(g))for(;d<=g;d++)a.currentList[d].selected=!0,a.options.selectedRows.push(a.currentList[d])}else Xa&&(pa||v||"multi-simple"===a.options.selectionMode)?(d=null===b.selected||"undefined"===b.selected?!1:b.selected,b.selected=!d,b.selected?a.isObjInSelList(b)||
...
e,f);0<=k&&((d=b[a.options.rowFields.cells][k][a.options.cellFields.value])||(d=b[a.options.rowFields.cells][k][a.options.cellFields.text]),n.isObject(d)&&(d=d.value?d.value:d.text))}c[a.options.rowFields.cells]&&(k=a.getCellIndexInCollection(c[a.options.rowFields.cells],e,f),0<=k&&((g=c[a.options.rowFields.cells][k][a.options.cellFields.value])||(g=c[a.options.rowFields.cells][k][a.options.cellFields.text]),n.isObject(g)&&(g=g.value?g.value:g.text)));d=void 0!=d?d:null;g=void 0!=g?g:null;switch(a.options.sorting){case "ascending":if(d<
g)return-1;if(d>g)return 1;break;case "descending":if(d>g)return-1;if(d<g)return 1;break;default:return 0}})}}};var C=function(b){if(b){var c=n.isFieldAvailable(b.general,"iui-treegrid-column"),e;e=(e=b.header)?{content:n.isFieldAvailable(e.content,"iui-treegrid-column-header-cell-content"),disabled:n.isFieldAvailable(e.disabled,"iui-treegrid-column-header-disabled"),normal:n.isFieldAvailable(e.normal,"iui-treegrid-column-header"),hovered:n.isFieldAvailable(e.hovered,"iui-treegrid-column-header-hovered"),
selected:n.isFieldAvailable(e.selected,"iui-treegrid-column-header-selected")}:a.options.controlStyle.column.header;b=(b=b.footer)?{content:n.isFieldAvailable(b.content,"iui-treegrid-column-footer-cell-content"),disabled:n.isFieldAvailable(b.disabled,"iui-treegrid-column-footer-disabled"),normal:n.isFieldAvailable(b.normal,"iui-treegrid-column-footer"),hovered:n.isFieldAvailable(b.hovered,"iui-treegrid-column-footer-hovered"),selected:n.isFieldAvailable(b.selected,"iui-treegrid-column-footer-selected")}:
a.options.controlStyle.column.footer;return{general:c,header:e,footer:b}}return a.options.controlStyle.column};this.getExpandBoxStyle=function(b){return b?{general:n.isFieldAvailable(b.general,"iui-treegrid-expand-box"),animated:n.isFieldAvailable(b.animated,"iui-treegrid-expand-box-load"),expanded:n.isFieldAvailable(b.expanded,"iui-treegrid-expand-box-open"),collapsed:n.isFieldAvailable(b.collapsed,"iui-treegrid-expand-box-close")}:a.options.controlStyle.row.expandBox};var rb=function(b){if(b){var c;
c=(c=b.general)?{disabled:n.isFieldAvailable(c.disabled,"iui-treegrid-row-disabled"),focused:n.isFieldAvailable(c.focused,"iui-treegrid-row-focused"),normal:n.isFieldAvailable(c.normal,"iui-treegrid-row"),hovered:n.isFieldAvailable(c.hovered,"iui-treegrid-row-hovered"),selected:n.isFieldAvailable(c.selected,"iui-treegrid-row-selected")}:a.options.controlStyle.row.general;var e;var f=b.checkBox;f?(e=n.isFieldAvailable(f.general,"iui-checkbox"),f=(f=f.box)?{general:n.isFieldAvailable(f.general,"iui-checkbox-box"),
disabled:n.isFieldAvailable(f.disabled,"iui-checkbox-disabled"),checked:n.isFieldAvailable(f.checked,"iui-checkbox-checked"),indeterminate:n.isFieldAvailable(f.indeterminate,"iui-checkbox-indeterminate"),unchecked:n.isFieldAvailable(f.unchecked,"iui-checkbox-unchecked")}:a.options.controlStyle.row.checkBox.box,e={general:e,box:f}):e=a.options.controlStyle.row.checkBox;f=a.getExpandBoxStyle(b.expandBox);b=(b=b.cell)?{content:n.isFieldAvailable(b.content,"iui-treegrid-row-cell-content"),general:n.isFieldAvailable(b.general,
"iui-treegrid-row-cell"),disabled:n.isFieldAvailable(b.disabled,"iui-treegrid-row-cell-disabled"),focused:n.isFieldAvailable(b.focused,"iui-treegrid-row-cell-focused"),normal:n.isFieldAvailable(b.normal,"iui-treegrid-row-cell"),hovered:n.isFieldAvailable(b.hovered,"iui-treegrid-row-cell-hovered"),selected:n.isFieldAvailable(b.selected,"iui-treegrid-row-cell-selected")}:a.options.controlStyle.row.cell;return{general:c,checkBox:e,expandBox:f,cell:b}}return a.options.controlStyle.row},z=function(b){return b?
{content:n.isFieldAvailable(b.content,"iui-treegrid-row-cell-content"),general:n.isFieldAvailable(b.general,"iui-treegrid-row-cell"),disabled:n.isFieldAvailable(b.disabled,"iui-treegrid-row-cell-disabled"),focused:n.isFieldAvailable(b.focused,"iui-treegrid-row-cell-focused"),normal:n.isFieldAvailable(b.normal,"iui-treegrid-row-cell"),hovered:n.isFieldAvailable(b.hovered,"iui-treegrid-row-cell-hovered"),selected:n.isFieldAvailable(b.selected,"iui-treegrid-row-cell-selected")}:a.options.controlStyle.cell};
this.updateControlStyle=function(b){a.options.controlStyle=b?{general:n.isFieldAvailable(b.general,"iui-treegrid"),column:C(b.column),row:rb(b.row),cell:z(b.cell)}:{general:n.isFieldAvailable(a.defaultStyle.general,"iui-treegrid"),column:C(a.defaultStyle.column),row:rb(a.defaultStyle.row),cell:z(a.defaultStyle.cell)}};this.getCurrentColumnStyle=function(b,c,e){var f=a.options.controlStyle.column;b&&b.style&&(f=b.style);b=a.options.controlStyle.column.body;var g=f.body;switch(c){case "header":b=a.options.controlStyle.column.header;
...
k.$on("$destroy",function(a){A.s2t();Aa&&(e.cancel(Aa),Aa=null);ia&&ia.unbind("mousedown");m.unbind("click dblclick dragenter dragleave dragend drop keydown mousedown mouseleave mousemove mousewheel scroll touchstart touchmove touchend");angular.element(n).unbind("dragenter dragover dragend mousemove mousedown mouseup");B&&B.unbind("blur focus keydown mousedown");tc();D&&D.$destroy();w&&w.$destroy()});a.dragIcon=document.createElement("img");a.dragIcon.width=1;m.append(a.getDropMarkWindow());a.dropMark();
var pa=function(){Ga&&(e.cancel(Ga),Ga=null)};a.addDropMark=function(){var b;b=m[0];for(var c=null;b;){if(b===document.getElementsByTagName("body")[0]){c=b;break}b=b.offsetParent}if(b=c)angular.element(b).append(a.getDropMarkWindow()),a.dropMark()};a.removeDropMark=function(){a.getDropMarkWindow().remove()};a.isDropInRange=function(b){b=a.getMousePos(b);var c=m[0].getBoundingClientRect();b.x-=angular.element(n)[0].pageXOffset;b.y-=angular.element(n)[0].pageYOffset;var q=c.top+y,c=c.bottom-O;I&&v&&
(c-=v[0].offsetHeight);return b.y<q||b.y>c?!1:!0};var C=angular.element('<div style="opacity:0.75;position:absolute;z-index:999"></div>'),rb=function(){C&&(C.remove(),C.css("top","-9999999px"),C.css("left","-9999999px"))};a.getCellElemFromRow=function(b){return b&&(b=a.getElemFromRow(b))?a.getChildElement(b,"cell"):null};a.openEditor=function(b,c){if(b)switch(b.type){case "cell":c||(c=a.getColumnById(b[a.options.cellFields.cid]));if(!c){var q=a.getCellColumnIndex(b),r=a.columnsObj.getList();r&&0<=
q&&q<r.length&&(c=r[q])}if(c){var q=a.getCellType(b,a.getColumnRealIndex(c)),r=a.getCellRowIndex(b),x=a.getCellColumnIndex(b);if(r=a.getElemFromCell(r,x,c[a.options.columnFields.fixed]))switch(q){case "checkbox":break;case "combobox":break;case "incell":a.openInCellEditor(r,b,c);break;case "dropdown":a.openDropDownEditor(r,b,c);break;default:0!=b[a.options.cellFields.allowEdit]&&sb(null,r,0)}}}};a.closeEditor=function(b,c){if(b)switch(b.type){case "cell":if(c||(c=a.getColumnById(b[a.options.cellFields.cid])),
c)switch(a.getCellType(b,a.getColumnRealIndex(c))){case "incell":a.closeActiveEditor(b);break;case "dropdown":a.closeActiveEditor(b)}else a.closeActiveEditor()}else a.closeActiveEditor();d=null};var z=null,b=!1,d=null,G=null,h=angular.element('<span class="iui-edit-mark"></span>');a.openInCellEditor=function(l,p,q){b&&a.closeActiveEditor(p,!0);u();if(p&&q&&(d=p,q='<div ng-include="'+q[a.options.columnFields.editorTemplate]+'"></div>',z=angular.element('<div class="iui-incell-editor"></div>'),z.append(c(q)(k.$parent)),
0!=a.callBeforeEdit(p))){l.children().eq(0).append(z);b=!0;G="incell";pb();z.bind("mousedown",function(a){a.stopPropagation()});z.bind("mouseup",function(a){a.stopPropagation()});z.bind("click",function(a){a.stopPropagation()});z.bind("keydown",function(b){switch(b.keyCode){case 27:a.closeActiveEditor(d)}b.stopPropagation()});z.bind("keypress",function(a){a.stopPropagation()});z.bind("keyup",function(a){a.stopPropagation()});var r=e(function(){var a=g.getPadding(l[0]),b=parseInt(getComputedStyle(l[0]).width,
10)-(a.left+a.right),a=parseInt(getComputedStyle(l[0]).height,10)+2;z.css("width",b+"px");z.css("height",a+"px");z.css("top",l[0].offsetTop+"px");k.$apply();z.children&&1==z.children().length&&(b=z.children().eq(0),b.children&&1==b.children().length&&b.children().eq(0).css("height",a+"px"));e.cancel(r)},1)}};a.openDropDownEditor=function(l,p,q){b&&a.closeActiveEditor(p,!0);u();if(p&&q&&(d=p,q='<div ng-include="'+q[a.options.columnFields.editorTemplate]+'"></div>',z=angular.element('<div class="iui-dropdown-editor"></div>'),
z.append(c(q)(k.$parent)),0!=a.callBeforeEdit(p)))var r=e(function(){angular.element(Qa).append(z);z.bind("mousedown",function(a){a.stopPropagation()});z.bind("mouseup",function(a){a.stopPropagation()});z.bind("click",function(a){a.stopPropagation()});b=!0;G="dropdown";var a=l[0].getBoundingClientRect(),c=angular.element(n)[0].pageXOffset,p=angular.element(n)[0].pageYOffset,q=e(function(){var b=g.getPadding(l[0]),b=parseInt(getComputedStyle(l[0]).width,10)+(b.left+b.right),r=g.getPadding(z[0]),b=
b-(r.left+r.right),r=parseInt(getComputedStyle(z[0]).width,10);b<r&&(b=r);r=a.right-(b+3)+c;z.css("top",a.bottom+p+"px");z.css("left",r+"px");z.css("width",b+"px");k.$apply();e.cancel(q)},1);e.cancel(r)},1)};a.closeActiveEditor=function(c,p){b=!1;u();z&&z.remove();G=d=null;p||a.callAfterEdit(c)};var u=function(){z&&z.unbind("click keydown keypress keyup mousedown mouseup")},Ab=function(a,b){a&&(h.addClass("iui-edit-mark iui-edit-mark-"+b),a.append(h),h.css("left",a[0].offsetLeft+a[0].offsetWidth-
h[0].offsetWidth-2+"px"),h.css("top",a[0].offsetTop+(a[0].offsetHeight-h[0].offsetHeight)/2+"px"))},pb=function(){h&&("dropdown"!=G||"dropdown"==G&&!b)&&(h.removeAttr("class"),h.remove())},Xb=null,Fa=angular.element('<div class="iui-dropdown-mark"><span></span></div>'),Yb=function(a,b){!a||Ya&&!b||(a.append(Fa),Fa.css("top",a[0].offsetTop+"px"),Fa.css("left",a[0].offsetLeft+a[0].offsetWidth-Fa[0].offsetWidth+"px"),Fa.css("height",getComputedStyle(a[0]).height))},Ha=function(a){!Fa||Ya&&!a||Fa.remove()};
a.getCellType=function(b,c){var q=null,r="label";b&&(q=a.getColumnById(b[a.options.cellFields.cid]));!q&&0<=c&&c<a.columnList.length&&(q=a.columnList[c]);q&&(r=q[a.options.columnFields.editorType]);return r};var Qa=g.getBodyElem(m[0]),tb=g.getUniqueId(4),ca=null,Ya=!1,ub=0,ad=function(b,p,q){if(Qa&&b.items&&0<b.items.length){b=g.getUniqueId(4);var r=c('<iui-list name="'+b+'" style="position:absolute;top:-99px;height:100px" items="data['+p+"].column."+a.options.columnFields.editorSettings+'.items"></iui-list>')(D);
angular.element(Qa).append(r);ba.updateLayout(b);var x=e(function(){if(0<r.children().length){var a=r.children().eq(0);0<a.children().length&&(ub=angular.element(a.children().eq(0))[0].offsetHeight,q&&(q.avgItemHeight=ub))}r.remove();e.cancel(x)},1)}},Ra=null,Bb=function(b,p,q,r){var x=a.getCell(q,r);if(x!=Xb&&(Xb=x,ca&&ca.remove(),Ra&&Ra.$destroy(),Qa)){Ra=k.$new();Ra.data=a.columnList[r];d=x;var f='<iui-list name="'+tb+'" style="position:absolute;"',f=f+(' items="data.'+a.options.columnFields.editorSettings+
'.items"'),f=f+(' item-icon="data.'+a.options.columnFields.editorSettings+'.itemIcon"'),f=f+(' show-icons="data.'+a.options.columnFields.editorSettings+'.showIcons"'),f=f+(' checkbox-settings="data.'+a.options.columnFields.editorSettings+'.checkBoxSettings"'),f=f+(' show-check-boxes="data.'+a.options.columnFields.editorSettings+'.checkBoxSettings.showCheckBoxes"');ca=c(f+(' nav-selection="false" before-select="onCellValueChanging(e, '+q+", "+r+')" after-select="onCellValueChanged(e, '+q+", "+r+')"></iui-list>'))(Ra);
ub=0;Za&&r<Za.length&&(ub=Za[r].avgItemHeight);var $c=e(function(){angular.element(Qa).append(ca);var c=b[0].getBoundingClientRect(),r=angular.element(n)[0].pageXOffset,q=angular.element(n)[0].pageYOffset,q=c.bottom+q-1,c=c.left+r,r=b.children().eq(0),d=g.getPadding(r[0]),r=parseInt(getComputedStyle(r[0]).width,10)+(d.left+d.right),d=g.getPadding(ca[0]),r=r-(d.left+d.right);void 0!=p.dropDownWidth&&r<p.dropDownWidth&&(r=p.dropDownWidth);d=void 0!=p.dropDownHeight?p.dropDownHeight:100;void 0!=p.maxDropDownItems&&
(d=ub*p.maxDropDownItems);ca.css("top",q+"px");ca.css("left",c+"px");ca.css("width",r+"px");ca.css("height",d+"px");ca.css("z-index","999");x&&x[a.options.cellFields.value]&&ba.selectedItem(tb,x[a.options.cellFields.value]);ba.updateLayout(tb);var f=e(function(){if(x&&x[a.options.cellFields.value]){ba.ensureVisible(tb,x[a.options.cellFields.value]);var b=e(function(){ba.focus(tb,x[a.options.cellFields.value]);e.cancel(b)},1)}e.cancel(f)},10);Fa&&(Ha(!0),Yb(b,!0));Ya=!0;bd();e.cancel($c)},1)}};a.removeDropDownList=
function(a){ca&&(Xb=null,ca.remove(),Ya=!1,a||Ha(),ca.unbind("keydown"));Ra&&Ra.$destroy();d=null};var bd=function(){ca.bind("keydown",function(b){switch(b.keyCode){case 27:a.removeDropDownList(),Ha()}})},sb=function(b,c,q){a.options.labelEdit&&(void 0===q&&(q=500),ya=e(function(){if(ya)var a=e(function(){Cb(b,c,!0);e.cancel(a)},q);e.cancel(ya)},q/3))},Db=function(){ya&&(e.cancel(ya),ya=null)},$a=null,ab=null,Cb=function(b,c,q){if(a.dragDropStatus())g=B[0].value,a.labelEditStatus(!1),B.unbind("blur focus keydown mousedown"),
B.remove(),ab=$a=null;else{var r=a.getRowFromChildElem(c);if(r){var x=a.getRowCurrentIndex(r),d=a.getIndexFromElem(c),f=a.getCellObject(x,d),g="",g=c.children().eq(0);if(f)if(q){if(0!=a.callBeforeLabelEdit(f)){$a=r;ab=f;a.labelEditStatus(!0);B.unbind("blur focus keydown mousedown");b=parseInt(getComputedStyle(c[0]).width,10)-4;q=parseInt(getComputedStyle(c[0]).height,10)-3;B.css("top",c[0].offsetTop+"px");B.css("left",c[0].offsetLeft+"px");B.css("width",b+"px");B.css("height",q+"px");g.append(B);
B[0].value=f[a.options.cellFields.text];B.bind("keydown",function(b){switch(b.keyCode){case 13:f[a.options.cellFields.text]=B[0].value?B[0].value:"null";Cb(b,c,!1);break;case 27:Cb(b,c,!1)}b.stopPropagation()});B.bind("focus",function(b){var c=angular.element(this);a.callGotFocus(b,$a,ab,!0,c[0].value)});B.bind("blur",function(a){Cb(a)});B.bind("mousedown",function(a){a.stopPropagation()});var h=e(function(){B[0].focus();B[0].select();e.cancel(h)},10)}}else g=B[0].value,a.labelEditStatus(!1),B.unbind("blur focus keydown mousedown"),
B.remove(),a.updateView(),a.updateFocus(x,d),a.callAfterLabelEdit(f),a.callLostFocus(b,r,f,!0,g),ab=$a=null}else g=B[0].value,a.labelEditStatus(!1),B.unbind("blur focus keydown mousedown"),B.remove(),a.callAfterLabelEdit(),a.updateView(),a.callLostFocus(b,$a,ab,!0,g),ab=$a=null}};m.bind("mousemove",function(b){if(a.options.enabled&&0===b.button&&la&&P){a.getColumnCurrentIndex(P);var c=a.getMousePos(b),q=c.y+16,c=c.x+20;qa.empty();qa.append("<span>"+P[a.options.columnFields.headerText]+"</span>");
qa.css("top",q+"px");qa.css("left",c+"px");qa.css("display","block");uc();b.stopPropagation()}});var xc=function(){for(var b=0,c="none";3>b;){if((c=a.getRowElems(c))&&0<c.length)for(var q=0;q<c.length;q++){var r=angular.element(c[q]);vc(r);for(var r=r.find("td"),x=0;x<r.length;x++){var d=angular.element(r[x]),e=a.getElement(d,"expandbox");e&&e.unbind("click touchend");wc(d)}}b++;c=1==b?"left":"right"}},tc=function(){u();for(var b=0,c="none";3>b;){var q=a.getRowElems(c);if(q&&0<q.length)for(var r=
0;r<q.length;r++){var x=angular.element(q[r]);vc(x);for(var x=x.find("td"),d=0;d<x.length;d++){var e=angular.element(x[d]),f=a.getElement(e,"expandbox");f&&f.unbind("click touchend");wc(e)}}if((q=a.getHeaderElem(c))&&0<q.length)for(r=0;r<q.length;r++)for(x=angular.element(q[r]),x=x.find("td"),d=0;d<x.length;d++)(e=angular.element(x[d]))&&(c=a.getChildElement(e,"column-header-cell"))&&(c=a.getContentElement(c,"filter-button"))&&c.unbind("mousedown");b++;c=1==b?"left":"right"}},fd=function(){xc();for(var b=
0,c="none";3>b;){if((c=a.getRowElems(c))&&0<c.length)for(var q,r=c.length-1,x=0;x<=r;x++){q=angular.element(c[x]);cd(q);for(var d=q.find("td"),e=0;e<d.length;e++){var f=angular.element(d[e]);dd(a.getElement(f,"expandbox"));ed(f,a.getRowFromElem(q),e)}}b++;c=1==b?"left":"right"}},la=!1,P=null,bb=-1,Eb=function(b,c){if(b){var q=a.getColumnCurrentIndex(b),r=a.getColumnWidth(b);return a.isColumnWithFixedWidth(q)||10<c.x&&c.x<r-10}return!1},ac=function(b){b=b.find("td");for(var c=0;c<b.length;c++)currentElem=
angular.element(b[c]),currentElem.bind("click",function(b){if(a.options.enabled&&1===b.which){var c=g.getClientMousePos(b,this),l=a.getColumnFromElem(this);l&&Eb(l,c)&&a.callColumnClick(l,a.getMousePos(b))}b.stopPropagation()}),currentElem.bind("dblclick",function(b){b.preventDefault();if(a.options.enabled&&1===b.which){var c=g.getClientMousePos(b,this),l=a.getColumnFromElem(this);l&&Eb(l,c)&&a.callColumnDblClick(l,a.getMousePos(b))}b.stopPropagation()}),currentElem.bind("mouseenter",function(b){if(a.options.enabled&&
!R&&!ma){var c=a.getColumnFromElem(this);c&&(a.hoverColumn=c,a.refresh(c),a.callColumnHover(c));if(1===b.which&&la&&P&&a.hoverColumn&&0!=a.hoverColumn[a.options.columnFields.allowDrop]&&da&&(da.remove(),a.hoverColumn!=P)){var l=angular.element(this);l.append(da);b=parseInt(getComputedStyle(l[0]).height,10);c=parseInt(getComputedStyle(da[0]).height,10);l=g.getPadding(l[0]);da.css("top",(b+l.top+l.bottom-c)/2+"px")}}}),currentElem.bind("mouseleave",function(b){!a.options.enabled||R||ma||(a.hoverColumn=
null,(b=a.getColumnFromElem(this))&&a.refresh(b),da&&da.remove(),R||m.css("cursor","default"))}),currentElem.bind("mousemove",function(b){if(a.options.enabled){var c=angular.element(this);if(1===b.which&&la&&P&&a.hoverColumn&&a.hoverColumn!=P&&0!=a.hoverColumn[a.options.columnFields.allowDrop]&&P[a.options.columnFields.fixed]==a.hoverColumn[a.options.columnFields.fixed])c=parseInt(getComputedStyle(c[0]).width,10),da.empty(),bb=-1,b.offsetX>c/2?(bb=2,da.append('<span class="iui-treegrid-column-reorder-mark-right"></span>'),
da.css("left","auto"),da.css("right","0")):(bb=1,da.append('<span class="iui-treegrid-column-reorder-mark-left"></span>'),da.css("left","0"),da.css("right","auto"));else{b=g.getClientMousePos(b,this);var c=parseInt(a.getIndexFromElem(this),10),l=a.getColumnWidth(a.columnList[c]),p=10;a.isFilteringAllowed(a.columnList[c])&&(p=0);10>b.x&&!a.isColumnWithFixedWidth(c-1)&&yc(c,"left")?(m.css("cursor","ew-resize"),Ba="left"):b.x>l-p&&!a.isColumnWithFixedWidth(c)&&yc(c,"right")?(m.css("cursor","ew-resize"),
Ba="right"):R||(m.css("cursor","default"),Ba="none")}}}),currentElem.bind("mouseup",function(b){if(a.options.enabled){if(1===b.which&&la&&P&&a.hoverColumn&&a.hoverColumn!=P&&0!=a.hoverColumn[a.options.columnFields.allowDrop]&&P[a.options.columnFields.fixed]==a.hoverColumn[a.options.columnFields.fixed]&&0!=a.callColumnPosChanging(P,a.hoverColumn)){b=a.columnList[0];0<=a.options.expandColIndex&&a.options.expandColIndex<a.columnList.length&&(b=a.columnList[a.options.expandColIndex]);var c=a.getColumnCurrentIndex(P),
c=a.getColumnRealIndex(c),l=a.getColumnCurrentIndex(a.hoverColumn),l=a.getColumnRealIndex(l);c!=l&&(c<l?1==bb&&l--:c>l&&2==bb&&l++,a.columnsObj.moveObject(c,l),a.updateColumnList(),b=a.getColumnCurrentIndex(b),b!=a.options.expandColIndex&&(a.options.expandColIndex=b),a.updateLayout(),a.callColumnPosChanged(P,a.hoverColumn))}P=null;bb=-1;R=la=!1;m.css("cursor","default")}}),currentElem.bind("mousedown",function(b){if(a.options.enabled){a.removeDropDownList();a.closeFilterWindow();a.closeEditor();g.getClientMousePos(b,
this);var c=parseInt(a.getIndexFromElem(this),10);if(0===b.button&&!R){var l=c,p="none";0<=c&&c<a.columnList.length&&(p=a.columnList[c][a.options.columnFields.fixed]);switch(Ba){case "left":"right"==p?l=c:(c=Zb(l-1,p))?(l=a.getColumnCurrentIndex(c),0<=l&&l<a.columnList.length&&(a.columnList[l][a.options.columnFields.fixed]!=p?(l=-1,R=!1):R=!0)):R=!1;0<=l&&(R=!0);break;case "right":"right"==p?(c=$b(l+1,p))?(l=a.getColumnCurrentIndex(c),0<=l&&l<a.columnList.length&&(a.columnList[l][a.options.columnFields.fixed]!=
p?(l=-1,R=!1):R=!0)):R=!1:(l=c,R=!0)}!a.isColumnWithFixedWidth(l)&&R?a.setColumnResizingParams(l,Ba,a.getMousePos(b).x):R=!1}if(!R&&(l=a.getColumnFromChildElem(this)))switch(p=g.getClientMousePos(b,this),Eb(l,p)&&a.columnSelection(l),b.which){case 1:a.options.allowColumnReorder&&0!=l[a.options.columnFields.allowDrag]&&0==la&&(P=l,a.getMousePos(b),la=!0,(l=g.getBodyElem(m[0]))&&angular.element(l).append(qa));break;case 3:Eb(l,p)&&a.callColumnRightClick(l,a.getMousePos(b))}}b.stopPropagation()}),function(b){b&&
(b=a.getChildElement(b,"column-header-cell"))&&(b=a.getContentElement(b,"filter-button"))&&b.bind("mousedown",function(a){1==a.which&&gd(this);a.stopPropagation()})}(currentElem)},ia=null,gd=function(b){a.closeFilterWindow();var p=a.getColumnFromChildElem(b);if(p){var q=angular.element(b),r=q.parent().parent();if(Qa){b='<div ng-include="'+p[a.options.columnFields.filterTemplate]+'"></div>';ia=angular.element('<div class="iui-filter-window"></div>');ia.append(c(b)(k.$parent));var x=e(function(){angular.element(Qa).append(ia);
ia.bind("mousedown",function(a){a.stopPropagation()});q[0].getBoundingClientRect();var a=r[0].getBoundingClientRect(),b=angular.element(n)[0].pageXOffset,c=angular.element(n)[0].pageYOffset,l=e(function(){var r=a.bottom+c,p=a.right-(parseInt(getComputedStyle(ia[0]).width,10)+3)+b;ia.css("top",r+"px");ia.css("left",p+"px");e.cancel(l)},1);e.cancel(x)},1)}}};a.closeFilterWindow=function(){ia&&(ia.unbind("mousedown"),ia.remove())};var vc=function(a){a&&a.unbind("blur dragover dragend focus keydown keyup keypress mousedown mouseenter mouseleave")},
cd=function(b){b&&(b.bind("dragover",function(b){var c=a.getRowFromElem(this);if(c&&a.isRowEnabled(c)){if(a.isScrollBarVisible("vertical")){var c=a.getMousePos(b),l=m[0].getBoundingClientRect();c.x-=angular.element(n)[0].pageXOffset;c.y-=angular.element(n)[0].pageYOffset;var x=l.top+y+25,l=l.bottom-O-25;I&&v&&(l-=v[0].offsetHeight);c.y<x?Fb(!1):c.y>l?Fb(!0):cb()}else cb();b.stopPropagation()}}),b.bind("dragend",function(b){var c=a.getRowFromElem(this);c&&a.isRowEnabled(c)&&(b.preventDefault(),a.dragDropStatus(!1),
a.dropMark(),t.getData().source||t.clearData())}),b.bind("mouseenter",function(b){if(!ma){var c=a.getRowFromElem(this);c&&a.isRowEnabled(c)&&!la&&(a.hoverRow=c,a.refresh(c),a.callRowHover(b,c),a.options.hoverSelection&&(za=e(function(){za&&a.rowSelection(c,b.shiftKey,b.ctrlKey,b.metaKey)},500)))}}),b.bind("mouseleave",function(b){ma||(a.hoverRow=null,(b=a.getRowFromElem(this))&&a.isRowEnabled(b)&&a.refresh(b),za&&(e.cancel(za),za=null))}),b.bind("keydown",function(b){var c=a.getRowFromElem(this);
if(c&&a.isRowEnabled(c)){var l=!0;a.callKeyDown(b,c);var x=a.getRowCurrentIndex(c);switch(b.keyCode){case 9:zc(b,c,x);break;case 16:a.updateSelectionStatus("shift");break;case 17:a.updateSelectionStatus("ctrl");break;case 27:l=!1;break;case 33:Ac(b,x);break;case 34:Bc(b,x);break;case 35:Cc(b,x);break;case 36:Dc(b,x);break;case 37:Ec(b,c,x);break;case 32:Fc(b,c);break;case 38:bc(b,x);break;case 39:Gc(b,c,x);break;case 40:cc(b,x);break;default:(b.ctrlKey||b.metaKey)&&a.updateSelectionStatus("ctrl"),
b.shiftKey&&a.updateSelectionStatus("shift")}l&&b.stopPropagation()}}),b.bind("keyup",function(b){var c=a.getRowFromElem(this);if(c&&a.isRowEnabled(c)){switch(b.keyCode){case 16:a.multiSelection(!1);break;case 17:a.multiSelection(!1);break;default:b.ctrlKey||b.metaKey||a.multiSelection(!1),b.shiftKey||a.multiSelection(!1)}a.callKeyUp(b,c)}}),b.bind("keypress",function(b){var c=a.getRowFromElem(this);c&&a.isRowEnabled(c)&&a.callKeyPress(b,c)}),b.bind("mousedown",function(b){a.removeDropDownList();
a.closeFilterWindow();a.closeEditor()}),b.bind("focus",function(b){var c=a.getRowFromElem(this);c&&a.isRowEnabled(c)?a.callGotFocus(b,c):a.updateFocus()}),b.bind("blur",function(b){var c=a.getRowFromElem(this);c&&a.isRowEnabled(c)&&a.callLostFocus(b,c)}))},dd=function(b){b&&(b.bind("click",function(b){var c=a.getRowFromChildElem(this);c&&a.isRowEnabled(c)&&(a.toggle(c),a.updateFocus(a.getRowCurrentIndex(c),a.options.expandColIndex),b.stopPropagation())}),b.bind("touchend",function(b){b.preventDefault();
var c=a.getRowFromChildElem(this);c&&a.isRowEnabled(c)&&(a.toggle(c),a.updateFocus(a.getRowCurrentIndex(c),a.options.expandColIndex),b.stopPropagation())}))},Gb={x:0,y:0},db={x:0,y:0},eb=!1,dc=!1,Ca=null,Hc=function(){return{x:angular.element(n)[0].pageXOffset,y:angular.element(n)[0].pageYOffset}},fb=function(a){var b=Hc();return{x:a.x-b.x,y:a.y-b.y}},ed=function(c,p,q){c&&(c.bind("dragstart",function(b){if(a.labelEditStatus())b.preventDefault();else{t.clearData();var c=a.getRowFromChildElem(this);
if(c&&a.isRowEnabled(c))if(Db(),a.isDragAllowed(c)){a.dragDropStatus(!0);a.addDropMark();b.dataTransfer?(b.dataTransfer.effectAllowed="move",b.dataTransfer.setData("text",c[a.options.rowFields.id]?c[a.options.rowFields.id].toString():"")):b.originalEvent&&b.originalEvent.dataTransfer&&(b.originalEvent.dataTransfer.effectAllowed="move",b.originalEvent.dataTransfer.setData("text",c[a.options.rowFields.id]?c[a.options.rowFields.id].toString():""));b={source:c,sourceCtrl:a,sourceCollection:a.rowsObj};
switch(a.options.selectionMode){case "multi-simple":b.source=a.options.selectedRows;break;case "multi-extended":b.source=a.options.selectedRows}t.setData(b)}else b.dataTransfer?b.dataTransfer.effectAllowed="none":b.originalEvent&&b.originalEvent.dataTransfer&&(b.originalEvent.dataTransfer.effectAllowed="none")}}),c.bind("dragover",function(b){var c=a.getRowFromChildElem(this);if(c&&a.isRowEnabled(c)){var l=angular.element(this);b.preventDefault();var p=!0;b.dataTransfer?p="none"===b.dataTransfer.effectAllowed?
!1:!0:b.originalEvent&&b.originalEvent.dataTransfer&&(p="none"===b.originalEvent.dataTransfer.effectAllowed?!1:!0);if(p&&(c=a.getRowFromChildElem(l))){var p=l[0].getBoundingClientRect(),d=angular.element(n)[0].pageXOffset,q=angular.element(n)[0].pageYOffset,e=a.getMousePos(b);e.x-=p.left+d;e.y-=p.top+q;l=t.getDropPos(e,{x:0,y:0,width:l[0].offsetWidth,height:l[0].offsetHeight});d=t.getData();p=a.isDropAllowed(d.source,c,l);q={event:b,sourceTree:d.sourceCtrl?d.sourceCtrl.getCtrlName():"",dragRow:d.source,
targetTree:a.getCtrlName(),targetRow:c,isDropAllowed:p,dropPos:l,mousePos:a.getMousePos(b)};q=a.callDragOver(q);if(p&&!1!==q){q=a.getMousePos(b);b=q.y+16;q=q.x+20;e=a.getDropMarkWindow();e.empty();var f="iui-drop-marker-move-in";switch(l){case 1:f="iui-drop-marker-move-up";break;case 2:f="iui-drop-marker-move-down"}e.append("<span class='"+f+"'></span><span class='iui-drop-marker-title'>"+c[a.options.rowFields.text]+"</span>");a.updateDropMarkElem(a.getDropMarkWindow(),{top:b,left:q});a.dropMark(p);
t.setData({source:d.source,sourceList:d.sourceList,target:c,dropPos:l})}else b.dataTransfer?b.dataTransfer.dropEffect="none":b.originalEvent&&b.originalEvent.dataTransfer&&(b.originalEvent.dataTransfer.dropEffect="none"),a.dropMark()}}}),c.bind("drop",function(b){var c=a.getRowFromChildElem(this);if(c&&a.isRowEnabled(c)){var l=angular.element(this);b.preventDefault();pa();a.dropMark();c=!0;b.dataTransfer?c="none"===b.dataTransfer.effectAllowed?!1:!0:b.originalEvent&&b.originalEvent.dataTransfer&&
(c="none"===b.originalEvent.dataTransfer.effectAllowed?!1:!0);if(c){var p=a.getRowFromChildElem(l);if(p){var l=t.getData(),d=l.source;d||(d=a.getDnDSource(b));if(c=a.isDropAllowed(d,p,l.dropPos)){a.toggle(p,!0);var q=a.getMousePos(b);d&&(c={event:b,sourceTree:l.sourceCtrl?l.sourceCtrl.getCtrlName():"",dragRow:d,targetTree:a.getCtrlName(),targetRow:p,targetCell:a.getCellAt(q.x,q.y),isDropAllowed:c,dropPos:l.dropPos,mousePos:q},!1!==a.callDragDrop(c)&&(a.drop(l),k.$$phase||k.$apply()))}}}t.clearData();
b.stopPropagation()}}),c.bind("dragenter",function(b){var c=a.getRowFromChildElem(this);if(c&&a.isRowEnabled(c)){b.preventDefault();if(a.options.autoExpand)var l=e(function(){Ga||(Ga=e(function(){Ga&&a.toggle(c,!0)},750));e.cancel(l)},1);var p=t.getData();p.source||(p.source=a.getDnDSource(b));p={event:b,sourceTree:p.sourceCtrl?p.sourceCtrl.getCtrlName():"",dragRow:p.source,targetTree:a.getCtrlName(),targetRow:p.target,mousePos:a.getMousePos(b)};a.callDragEnter(p);b.stopPropagation()}}),c.bind("dragleave",
function(b){a.hoverRow=null;var c=a.getRowFromChildElem(this);c&&a.isRowEnabled(c)&&(b.preventDefault(),pa(),c=t.getData(),c.source||(c.source=a.getDnDSource(b)),c={event:b,sourceTree:c.sourceCtrl?c.sourceCtrl.getCtrlName():"",dragRow:c.source,targetTree:a.getCtrlName(),targetRow:c.target,mousePos:a.getMousePos(b)},a.callDragLeave(c),b.stopPropagation())}),c.bind("touchstart",function(c){var l=a.getRowFromChildElem(this);if(l&&a.isRowEnabled(l)&&(c.preventDefault(),(l=a.getTouchData(c))&&0<l.length)){dc=
!0;var p=e(function(){dc=!1;e.cancel(p)},750);Gb=fb({x:l[0].pageX,y:l[0].pageY});a.closeFilterWindow();l=Gb;if((l=a.getRowAt(l.x,l.y))&&a.isRowEnabled(l)){var q=angular.element(this);a.mouseButtonStatus(!0);Ca=l;var f=a.getRowCurrentIndex(l),g=parseInt(a.getIndexFromElem(this),10),h=a.getCell(f,g),k=a.getCellType(h,g),m=null,n=a.options.editorSettings;q[0].focus();a.updateFocus(f,g);h&&(m=a.getColumnById(h[a.options.cellFields.cid]));!m&&0<=g&&g<a.columnList.length&&(m=a.columnList[g]);var t="click"==
a.options.editorSettings.activate;m&&m[a.options.columnFields.editorSettings]&&(n=m[a.options.columnFields.editorSettings],t=void 0!=n.activate?"click"==n.activate:t);h&&h!=d?a.closeEditor(d):a.closeEditor();switch(k){case "checkbox":break;case "combobox":a.rowSelection(l,c.shiftKey,c.ctrlKey,c.metaKey);h&&0!=h[a.options.cellFields.allowEdit]&&m&&t?Bb(angular.element(this),n,f,g):a.removeDropDownList();break;case "incell":a.rowSelection(l,c.shiftKey,c.ctrlKey,c.metaKey);!b&&h&&0!=h[a.options.cellFields.allowEdit]&&
...
var p=Math.abs(db.x-Gb.x),d=Math.abs(db.y-Gb.y),q=m[0].getBoundingClientRect();if(t.hitTest(db.x,db.y,q)){if(b.preventDefault(),C&&C.css("display","block"),!dc)if(!eb&&(2<p||2<d)&&Ca&&a.isRowEnabled(Ca))if(angular.element(this),a.labelEditStatus())b.preventDefault();else{eb=!0;t.clearData();if((p=a.getTouchData(b))&&0<p.length&&(fb({x:p[0].pageX,y:p[0].pageY}),Ca&&a.isRowEnabled(Ca)&&(Db(),a.isDragAllowed(Ca)))){a.dragDropStatus(!0);a.addDropMark();p={source:Ca,sourceCtrl:a,sourceCollection:a.rowsObj};
switch(a.options.selectionMode){case "multi-simple":p.source=a.options.selectedRows;break;case "multi-extended":p.source=a.options.selectedRows}t.setData(p);if(p=a.getCellElemFromRow(Ca))if(p=a.getContentElement(p))C.empty(),C.append(p.clone()),C.css("display","none"),m.append(C)}b.stopPropagation()}else if(eb&&(angular.element(this),b.preventDefault(),(d=a.getTouchData(b))&&0<d.length)){var p=Hc(),e=fb({x:d[0].pageX,y:d[0].pageY});if(d=a.getRowAt(e.x,e.y)){var f=a.getCellElemFromRow(d);if(f){var q=
f[0].getBoundingClientRect(),f=t.getDropPos({x:e.x-q.left,y:e.y-q.top},{x:0,y:0,width:f[0].offsetWidth,height:f[0].offsetHeight}),q=t.getData(),g=a.isDropAllowed(q.source,d,f);b={event:b,sourceTree:q.sourceCtrl?q.sourceCtrl.getCtrlName():"",dragRow:q.source,targetTree:a.getCtrlName(),targetRow:d,isDropAllowed:g,dropPos:f,mousePos:e};l=m[0].getBoundingClientRect();c=e.x-l.left;l=e.y-l.top;C.css("top",l-16+"px");C.css("left",c+"px");C.css("display","block");b=a.callDragOver(b);if(g&&0!=b){b=e.y+p.y+
16;p=e.x+p.x+20;e=a.getDropMarkWindow();e.empty();c="iui-drop-marker-move-in";switch(f){case 1:c="iui-drop-marker-move-up";break;case 2:c="iui-drop-marker-move-down"}e.append("<span class='"+c+"'></span><span class='iui-drop-marker-title'>"+d[a.options.rowFields.text]+"</span>");a.updateDropMarkElem(a.getDropMarkWindow(),{top:b,left:p});a.dropMark(g);t.setData({source:q.source,sourceList:q.sourceList,target:d,dropPos:f})}else a.dropMark(),C&&C.css("display","none")}}else q=m[0].getBoundingClientRect(),
d=q.top+y,q=q.bottom-O,I&&v&&(q-=v[0].offsetHeight),!a.options.allowDrop||e.y<d||e.y>q?(a.dropMark(),C&&C.css("display","none")):(l=m[0].getBoundingClientRect(),c=e.x-l.left,l=e.y-l.top,C.css("top",l-16+"px"),C.css("left",c+"px"),C.css("display","block"),d=t.getData(),q={source:d.source,sourceCtrl:d.sourceCtrl,target:null,dropPos:-1},t.setData(q),b={event:b,sourceTree:d.sourceCtrl?d.sourceCtrl.getCtrlName():"",dragRow:d.source,targetTree:a.getCtrlName(),targetRow:null,isDropAllowed:a.options.allowDrop,
...
p=parseInt(a.getIndexFromElem(this),10),l=a.getCell(l,p);a.callLostFocus(b,c,l)}}))},wc=function(a){a&&a.unbind("blur click dragstart dragover drop dragenter dragleave dblclick focus keydown keypress keyup mouseenter mouseleave mousemove mousedown mouseup touchstart touchmove touchend")};a.getTopRow=function(){return a.isRowIndexInRange(E-1)?a.currentList[E]:0<a.currentList.length?a.currentList[0]:null};a.getFooterElem=function(a){switch(a){case "left":return ja;case "right":return Y}return ra};a.getHeaderElem=
function(a){switch(a){case "left":return Z;case "right":return S}return ea};a.getRowElems=function(a){switch(a){case "left":return Ia?Ia.find("tr"):null;case "right":return Ja?Ja.find("tr"):null}return fa?fa.find("tr"):null};var zc=function(b,c,d,e){var f=a.currentList.length;0<f&&(b.shiftKey?g.isEqual(c[a.options.rowFields.id],a.currentList[0][a.options.rowFields.id])||bc(b,d,e):g.isEqual(c[a.options.rowFields.id],a.currentList[f-1][a.options.rowFields.id])||cc(b,d,e))},cc=function(b,c,d){b.preventDefault();
focusDelayTime=0;var r=c,f=E+ga-2,f=f<a.currentList.length-1?f:a.currentList.length-1;r>=f&&K&&(a.setScrollPos({x:a.scrollPos.x,y:a.scrollPos.y+Math.floor(m[0].clientHeight/4)}),focusDelayTime=1);if(r=a.getNextRow(r)){c=a.getRowCurrentIndex(r);c>f&&K&&(a.ensureVisible(r,"bottom"),focusDelayTime=100);a.rowSelection(r,b.shiftKey,b.ctrlKey,b.metaKey);var g=e(function(){a.updateFocus(c,d);e.cancel(g)},focusDelayTime)}},bc=function(b,c,d){b.preventDefault();focusDelayTime=0;var r=E,r=0<r?r:0;c==r&&K&&
(a.setScrollPos({x:a.scrollPos.x,y:a.scrollPos.y-Math.floor(m[0].clientHeight/4)}),focusDelayTime=1);var f=a.getPrevRow(c);if(f){c=a.getRowCurrentIndex(f);c<r&&K&&(a.ensureVisible(f,"bottom"),focusDelayTime=100);a.rowSelection(f,b.shiftKey,b.ctrlKey);var g=e(function(){a.updateFocus(c,d);e.cancel(g)},focusDelayTime)}},Gc=function(b,c,d,r){b.preventDefault();if((void 0===r||0<=r&&r==a.options.expandColIndex)&&!a.isRowExpanded(c)&&c[a.options.rowFields.rows]&&0<c[a.options.rowFields.rows].length)a.toggle(c,
!0),a.updateFocus(d,r);else if(0<=r){focusDelayTime=0;var f=r+1;b=a.columnList.length-1;f===b&&(focusDelayTime=1);if(0<=f&&f<=b){b=g.getPageRect(m);c=a.getElemFromCell(d,f);c=g.getPageRect(c);c.left+c.width>b.left+b.width&&(b=a.scrollPos,b.x+=c.width,a.setScrollPos(b));var h=e(function(){a.updateFocus(d,f);e.cancel(h)},focusDelayTime)}}},Ec=function(b,c,d,r){b.preventDefault();if((void 0===r||0<=r&&r==a.options.expandColIndex)&&a.isRowExpanded(c)&&c[a.options.rowFields.rows]&&0<c[a.options.rowFields.rows].length)a.toggle(c,
!1),a.updateFocus(d,r);else if(0<=r){focusDelayTime=0;var f=1<r?r-1:0;if(0<=f){b=g.getPageRect(m);c=a.getElemFromCell(d,f);c=g.getPageRect(c);c.left<b.left&&(b=a.scrollPos,b.x-=c.width,a.setScrollPos(b));var h=e(function(){a.updateFocus(d,f);e.cancel(h)},focusDelayTime)}}},Ac=function(b,c,d){b.preventDefault();var r=c-ga,r=0<r?r:0;if(r!==c){focusDelayTime=1;var f=a.getPrevRow(r+1);if(f){a.scrollTo(f);a.rowSelection(f,b.shiftKey,b.ctrlKey,b.metaKey);k.$apply();var g=e(function(){a.updateFocus(a.getRowCurrentIndex(f),
d);e.cancel(g)},focusDelayTime)}}},Bc=function(b,c,d){b.preventDefault();var f=c+ga;a.options.showHeader&&f--;a.options.showFooter&&f--;f=f<a.currentList.length-1?f:a.currentList.length-1;if(f!==c){focusDelayTime=1;var g=a.getNextRow(f-1);if(g){a.scrollTo(g,"bottom");a.rowSelection(g,b.shiftKey,b.ctrlKey,b.metaKey);k.$apply();var h=e(function(){a.updateFocus(a.getRowCurrentIndex(g),d);e.cancel(h)},focusDelayTime)}}},Cc=function(b,c,d){b.preventDefault();a.setScrollPos({x:a.scrollPos.x,y:L.y});var f=
a.getLastRow();if(f){a.rowSelection(f,b.shiftKey,b.ctrlKey,b.metaKey);var g=e(function(){a.updateFocus(a.getRowCurrentIndex(f),d);e.cancel(g)},1)}},Dc=function(b,c,d){b.preventDefault();a.setScrollPos({x:a.scrollPos.x,y:0});var f=a.getFirstRow();if(f){a.rowSelection(f,b.shiftKey,b.ctrlKey,b.metaKey);var g=e(function(){a.updateFocus(a.getRowCurrentIndex(f),d);e.cancel(g)},1)}},Ic=function(b,c){if(b&&0!=b[a.options.cellFields.allowEdit]){var d=a.getColumnById(b[a.options.cellFields.cid]);!d&&0<=c&&
c<a.columnList.length&&(d=a.columnList[c]);if(d){var e=b[a.options.cellFields.value];if((d=d[a.options.columnFields.editorSettings])&&1==d.threeState)switch(g.isString(e)||(e="unchecked"),e){case "checked":e="unchecked";break;case "indeterminate":e="checked";break;default:e="indeterminate"}else e=g.isBoolean(e)?!e:!0;b[a.options.cellFields.value]=e;k.$apply()}}},Fc=function(b,c,d,e){b.preventDefault();Ic(d,e);a.rowSelection(c,b.shiftKey,b.ctrlKey,b.metaKey,c.selected);k.$apply()},fa=null,sa=angular.element('<div class="iui-treegrid-block iui-treegrid-block-top"></div>'),
...
null;var L={x:0,y:0},Za=[];k.verScrollVisibility=!1;k.$watch("verScrollVisibility",function(b,c){b!=c&&a.updateCurrentLayout(!0)});a.getColumnWidth=function(b){var c=100;b&&b[a.options.columnFields.width]&&(c=b[a.options.columnFields.width],g.isPercent(c)?(b=m[0].clientWidth-2*a.columnList.length,K&&J&&(b-=J[0].offsetWidth),c=Math.floor(parseInt(c,10)/100*b)):g.isString&&(c=parseInt(c,10)));return c};var xb=function(b){var c=0;if((b=a.getRowElems(b))&&0<b.length&&(b=angular.element(b[0]))&&(b=b.find("td"))&&
0<b.length)for(var d=0;d<b.length;d++)var e=angular.element(b[d]),c=c+e[0].offsetWidth;return c},hd=function(){var b=0;if(a.options.showHeader||a.options.showFooter){var c=a.options.showHeader?a.getHeaderElem():a.getFooterElem();if(c&&(c=c.find("td"))&&0<c.length)for(var d=0;d<c.length;d++)var e=angular.element(c[d]),b=b+e[0].offsetWidth;a.isThereLeftFixedColumns&&(Z?Q=Z[0].offsetWidth:ja&&(Q=ja[0].offsetWidth),b+=Q);a.isThereRightFixedColumns&&(S?ua=S[0].offsetWidth:Y&&(ua=Y[0].offsetWidth),b+=ua)}else 0<
a.currentList.length&&(fa&&(b+=xb()),a.isThereLeftFixedColumns&&(b+=xb("left")),a.isThereRightFixedColumns&&(b+=xb("right")));return b};a.updateScrollVisibility=function(){var a=e(function(){I||(v.css("display","none"),L.x=0);K||(J.css("display","none"),L.y=0);I&&K||xa.css("display","none");e.cancel(a)},1)};m.append(v);m.append(J);m.append(xa);a.updateScrollVisibility();a.updateViewSize=function(b){var c=e(function(){ib=0;var b=m[0].clientWidth;K&&J&&(b-=J[0].offsetWidth);I=!1;0<a.columnList.length&&
(ib+=hd(),ib>b&&(v.unbind("mousedown"),v.css("display","block"),v.bind("mousedown",function(b){if(a.options.enabled){a.removeDropDownList();a.closeFilterWindow();a.closeEditor();b=g.getClientMousePos(b,this);var c=Math.floor(m[0].clientWidth);N&&(b.x<N[0].offsetLeft?a.setScrollPos({x:a.scrollPos.x-c,y:a.scrollPos.y}):b.x>N[0].offsetLeft+N[0].offsetWidth&&a.setScrollPos({x:a.scrollPos.x+c,y:a.scrollPos.y}))}}),N=angular.element(v.children().eq(0)),I=!0,N.bind("mousedown",function(b){a.options.enabled&&
...
"].related."+a.options.cellFields.tooltip+'">'),k+="{{data["+e+"].cells["+h+"].related."+a.options.cellFields.text+"}}",k+="</span>")}f+=k;f+="</div>";f+="</td>"}return f+"</tr>"},id=function(){T=0;if(0<a.options.rowHeight){var b={top:0,bottom:0};if(a.options.controlStyle&&a.options.controlStyle.row&&a.options.controlStyle.row.cell&&a.options.controlStyle.row.cell.content){var d=angular.element('<div class="'+a.options.controlStyle.row.cell.content+'" style="position:absolute;top:-9999999px;">Temp</div>');
m.append(d);b=g.getPadding(d[0]);d.remove()}T=a.options.rowHeight+b.top+b.bottom+3}else if(0<a.currentList.length&&w){for(var b=[],f=[],d=[],r=[],h=[],k=[],n=0,t=0;t<a.currentList.length&&10>t;t++)b.push(lb(t,"none",!0)),f.push(c(b[t])(w)),m.append(f[t]),a.isThereLeftFixedColumns&&(d.push(lb(t,"left",!0)),r.push(c(d[t])(w)),m.append(r[t])),a.isThereRightFixedColumns&&(h.push(lb(t,"right",!0)),k.push(c(h[t])(w)),m.append(k[t])),n++;if(0<n)var u=e(function(){for(var b=0,c=0,d=0,l=0;l<n;l++)b+=f[l][0].offsetHeight,
f[l].remove(),a.isThereLeftFixedColumns&&(c+=r[l][0].offsetHeight,r[l].remove()),a.isThereRightFixedColumns&&(d+=k[l][0].offsetHeight,k[l].remove());T=Math.floor(Math.max(Math.max(b,c),d)/n);e.cancel(u)},1)}},F=null,gc=0,hc=0,V=angular.element('<div class="iui-pagination-panel"></div>'),jd=function(){F&&F.$destroy();V.empty();V.remove();hc=gc=0;if(a.options.paging.showControlPanel){F=k.$new();F.currentPage=0;F.minPages=0;F.numPages=a.pageList.length;0<F.numPages&&0==F.currentPage&&(F.currentPage=
1);F.onFirstPage=function(){a.options.enabled&&(a.firstPage(),F.currentPage=a.currentPageNumber)};F.onLastPage=function(){a.options.enabled&&(a.lastPage(),F.currentPage=a.currentPageNumber)};F.onNextPage=function(){a.options.enabled&&(a.nextPage(),F.currentPage=a.currentPageNumber)};F.onPrevPage=function(){a.options.enabled&&(a.prevPage(),F.currentPage=a.currentPageNumber)};F.$watch("currentPage",function(b,c){a.options.enabled&&b!=c&&1<=b&&b<=a.pageList.length&&a.setCurrentPage(b)});gc=m[0].clientWidth;
...
Jc=function(){Ua&&(Ua.empty(),Ua.remove());ha&&(ha.empty(),ha.remove());ka&&(ka.empty(),ka.remove());Ma&&(Ma.empty(),Ma.remove());Na&&(Na.empty(),Na.remove())},kd=function(){if(1<a.updateStatus)M("end");else var b=e(function(){if(0<a.columnList.length&&1==a.updateStatus){D=k.$new();D.data=Kc();a.refreshColumns();D.$apply();var d;for(d=O=y=0;d<a.columnList.length;d++){var f={columnID:void 0!=a.columnList[d][a.options.columnFields.id]?a.columnList[d][a.options.columnFields.id]:d,avgItemHeight:0};switch(a.columnList[d][a.options.columnFields.editorType]){case "combobox":ad(a.columnList[d].editorSettings,
d,f);Za.push(f);break;default:Za.push(f)}}a.options.showHeader&&(m.append(ha),aa&&(sa.css("opacity",W.opacity),ha.css("opacity",W.opacity)),d=kb(),ea=angular.element(c(d)(D)),ha.append(ea),a.isThereLeftFixedColumns&&(d=kb(!1,"left"),Z=c(d)(D),ha.append(Z),Z.css("z-index","2"),Z.addClass("iui-treegrid-column-header-left")),a.isThereRightFixedColumns&&(d=kb(!1,"right"),S=c(d)(D),ha.append(S),S.css("right","0"),S.css("z-index","1"),S.addClass("iui-treegrid-column-header-right")));a.options.showFooter&&
(m.append(ka),aa&&(na.css("opacity",W.opacity),ka.css("opacity",W.opacity)),d=kb(!0),ra=c(d)(D),ka.append(ra),a.isThereLeftFixedColumns&&(d=kb(!0,"left"),ja=c(d)(D),ka.append(ja),ja.css("z-index","2"),ja.addClass("iui-treegrid-column-footer-left")),a.isThereRightFixedColumns&&(d=kb(!0,"right"),Y=c(d)(D),ka.append(Y),Y.css("right","0"),Y.css("z-index","1"),Y.addClass("iui-treegrid-column-footer-right")));var g,h;d=-1;for(f=0;f<a.columnList.length;f++)if(h=g=null,a.columnList[f][a.options.columnFields.templateSettings]&&
...
M("scroll");e.cancel(b)},1)},ld=function(){if(1<a.updateStatus)M("end");else var b=e(function(){var d=0;a.options.paging.enabled&&V&&(d=V[0].offsetHeight);if(0<a.columnList.length){var f=0;if(a.options.showHeader&&ea){y=ea[0].offsetHeight;a.isThereLeftFixedColumns&&Z?y=Z[0].offsetHeight:a.isThereRightFixedColumns&&S&&(y=S[0].offsetHeight);var g=0,h=ea.find("td");if(h&&0<h.length)for(var n=0;n<h.length;n++)var t=angular.element(h[n]),g=g+t[0].offsetWidth;g>m[0].clientWidth&&(g=angular.element('<div class="iui-scrollbar-horizontal"><div class="iui-scroll-button-thumb-horizontal"></div></div>'),
g.css("bottom","-9999px"),m.append(g),f=g[0].offsetHeight,g.remove());ha.css("width",m[0].clientWidth+"px");ha.css("height",y+"px");a.isThereLeftFixedColumns&&(Q=Z[0].offsetWidth,gb=m[0].clientHeight-y-O,ea.css("left",Q+"px"));a.isThereRightFixedColumns&&(ua=S[0].offsetWidth,hb=m[0].clientHeight-y-O)}a.options.showFooter&&(O=ra[0].offsetHeight,a.isThereLeftFixedColumns&&ja?O=ja[0].offsetHeight:a.isThereRightFixedColumns&&Y&&(O=Y[0].offsetHeight),ka.css("width",m[0].clientWidth+"px"),ka.css("height",
O+"px"),a.isThereLeftFixedColumns&&(Q=ja[0].offsetWidth,gb=m[0].clientHeight-y-O,ra.css("left",Q+"px")),a.isThereRightFixedColumns&&(ua=Y[0].offsetWidth,hb=m[0].clientHeight-y-O));Lc();if(0<a.currentList.length){w=k.$new();w.data=Mc();a.refreshRows();w.$apply();id();var u=e(function(){xc();fa&&fa.remove();Ia&&Ia.remove();Ja&&Ja.remove();var b=m[0].clientHeight-d-(y+O)-f;H=0<T?Math.floor(b/T)+1:0<y?Math.floor(b/y)+1:100;ga=0;for(var b="",l=0;l<H;l++)b+=lb(l),ga++;if(0<ga){fa=angular.element('<table cellpadding="0" cellspacing="0" style="position:absolute;top:'+
y+'px;"></table>');fa.append(c(b)(w));Ua.append(fa);if(a.isThereLeftFixedColumns){fa.css("left",Q+"px");b="";for(l=ga=0;l<H;l++)b+=lb(l,"left"),ga++;0<ga&&(Ia=angular.element('<table class="iui-treegrid-rows-left" cellpadding="0" cellspacing="0" style="position:absolute;"></table>'),Ia.append(c(b)(w)),Ma.append(Ia),m.append(Ma),aa&&(Da.css("opacity",W.opacity),Ma.css("opacity",W.opacity)))}if(a.isThereRightFixedColumns){b="";for(l=ga=0;l<H;l++)b+=lb(l,"right"),ga++;0<ga&&(Ja=angular.element('<table class="iui-treegrid-rows-right" cellpadding="0" cellspacing="0" style="position:absolute;"></table>'),
Ja.append(c(b)(w)),Na.append(Ja),m.append(Na),aa&&(ta.css("opacity",W.opacity),Na.css("opacity",W.opacity)))}}oa(70);M("scroll");e.cancel(u)},1)}else oa(70),M("scroll")}else oa(70),M("scroll");e.cancel(b)},1)},md=function(){switch(W.type){case "circular":Nc();mb=0;Oa=!0;1==a.updateStatus&&a.callLoadComplete();break;case "linear":Oc(!1);break;default:mb=0,Oa=!0,1==a.updateStatus&&a.callLoadComplete()}a.updateActive=!1;a.updateStatus--;if(0<a.updateStatus)nb=a.updateActive=!0,1==a.updateStatus?M("start"):
M("end");else if(Pc())var b=e(function(){a.updateView();a.callUpdateComplete();e.cancel(b)},1);else a.callUpdateComplete()},M=function(b){if(nb&&!Va)switch(b){case "start":1<a.updateStatus?M("end"):(a.updateColumnList(),a.options.paging.enabled&&a.updatePageList(),a.updateCurrentList(),oa(10),M("init"));break;case "init":1<a.updateStatus?M("end"):(Za.length=0,tc(),Ib||ma||ec(),Jc(),ra=ea=fa=null,gb=Q=0,Ia=Z=null,hb=ua=0,Ja=S=null,D&&D.$destroy(),w&&w.$destroy(),a.options.paging.enabled&&jd(),m.append(Ua),
oa(20),M("columns"));break;case "columns":kd();break;case "rows":ha?a.options.showHeader&&ha.find("td").length<a.columnList.length?e(function(){M(b)},1):ld():e(function(){M(b)},1);break;case "scroll":1<a.updateStatus?M("end"):(1==a.updateStatus&&(Ua&&(X.empty(),X.append(Ua.children())),ha&&(sa.empty(),sa.append(ha.children()),a.options.showHeader&&(sa.css("width",m[0].clientWidth+"px"),sa.css("height",y+"px")),m.append(sa)),ka&&(na.empty(),na.append(ka.children()),a.options.showFooter&&(na.css("width",
m[0].clientWidth+"px"),na.css("height",O+"px")),m.append(na)),Ma&&(Da.empty(),Da.append(Ma.children()),m.append(Da)),Na&&(ta.empty(),ta.append(Na.children()),m.append(ta)),a.updateViewSize(),a.updateViewSize(),a.updateScrollVisibility(),a.updateScrollView()),oa(80,"complete"),M("complete"));break;case "complete":1<a.updateStatus?M("end"):(Jc(),oa(90),M("events"));break;case "events":1<a.updateStatus||(a.allowEvents=!0,a.options.showHeader&&(ea&&ac(ea),a.isThereLeftFixedColumns&&Z&&ac(Z),a.isThereRightFixedColumns&&
S&&ac(S)),0<a.currentList.length&&fd(),oa(100));M("end");break;case "end":md()}else e(function(){M(b)},1)},Qc=5,Ob=0,Wa=0,Pb=0,Rc=0,Va=!1,Qb=!1,W={type:"none",speed:"normal",opacity:0},ic=null,aa=!1,Oa=!1,Oc=function(b){var c=f(function(){b?Wa++:Wa--;Pb=(m[0].clientHeight-Wa)/2+2;yb.css("height",Wa+"px");Ea.css("top",Pb+"px");b&&Wa>=Qc?(aa=!0,oa(0),Oa=Va=!1,f.cancel(c)):!b&&0>=Wa&&(Ea&&Ea.remove(),mb=0,Oa=!0,a.callLoadComplete(),f.cancel(c))},20)},Nc=function(){ic&&f.cancel(ic);wa&&wa.remove()};a.beginLoad=
function(a){if(!Va)switch(Va=!0,W=a?{type:void 0!=a.type?a.type:"none",speed:void 0!=a.speed?a.speed:"normal",opacity:void 0!=a.opacity?a.opacity:0}:{type:"none",speed:"normal",opacity:0},jc(W.opacity),W.type){case "circular":Nc();m.append(wa);wa.css("top",(m[0].clientHeight-wa[0].offsetHeight)/2+"px");wa.css("left",(m[0].clientWidth-wa[0].offsetWidth)/2+"px");aa=!0;Oa=Va=!1;var b=0,c=3;switch(W.speed){case "veryfast":c=7;break;case "fast":c=5;break;case "slow":c=2;break;case "veryslow":c=1}ic=f(function(){b+=
c;360<b&&(b=0);var a="rotate("+b+"deg)";wa.css("-ms-transform",a);wa.css("-webkit-transform",a);wa.css("transform",a)},1);break;case "linear":a=angular.element('<div class="iui-load-block-progress" style="position:absolute;left:-9999px"></div>');m.append(a);Qc=parseInt(getComputedStyle(a[0]).height,10);a.remove();yb.css("width","0px");yb.css("height","0px");m.append(Ea);mb=0;Ob=Math.floor(.5*m[0].clientWidth);Wa=0;Pb=m[0].clientHeight/2+2;Rc=(m[0].clientWidth-Ob)/2;Ea.css("width",Ob+"px");Ea.css("top",
Pb+"px");Ea.css("left",Rc+"px");Ea.css("opacity","1");Oc(!0);break;default:aa=!0,Oa=Va=!1}};a.endLoad=function(b){if(!Qb)if(Qb=!0,b=a.options.loadRows.indexOf(b),0<=b&&a.options.loadRows.splice(b,1),aa){aa=!1;var c=3,d=W.opacity,e=f(function(){Oa&&(10<c||1<=d?(jc(1),Qb=Va=Oa=!1,W={type:"none",speed:"normal"},f.cancel(e)):(d+=c/10,jc(d),c+=3))},1)}else Qb=!1};var jc=function(a){sa&&sa.css("opacity",a);Da&&Da.css("opacity",a);X&&X.css("opacity",a);ta&&ta.css("opacity",a);na&&na.css("opacity",a);v&&
...
e.cancel(c)},1)}};var nd=function(b,c){var d=a.options.enabled&&a.options.allowColumnReorder&&b[a.options.columnFields.allowDrag],e=b[a.options.columnFields.headerAlignment],f=b[a.options.columnFields.footerAlignment],g=a.isFilteringAllowed(b),h=a.isSortingAllowed()&&b==a.sortColumn,k=a.getColumnWidth(b),k=0<=k?k:0,m=kc(b);k<m.min&&(k=m.min);k>m.max&&(k=m.max);return{draggable:d,headerAlignment:e,footerAlignment:f,index:c,indent:0,column:b,showFiltering:g,showSorting:h,style:{header:{},footer:{}},
width:k}},Sc=function(b,c){if(0<=c){var d=a.currentList[b][a.options.rowFields.cells];if(c<d.length)return d[c]}return{}},Nb=function(b){return a.columnList[b][a.options.columnFields.cellTemplateUrl]?a.columnList[b][a.options.columnFields.cellTemplateUrl]:""},od=function(b,c,d){for(var e=[],f=0;f<a.columnList.length;f++){var h,k=f;if(d){var m=a.columnList[f][a.options.columnFields.id];m&&(k=a.getCellIndexById(a.currentList[c][a.options.rowFields.cells],f,m))}h=k;var k=d?Sc(c,h):{},m=a.columnList[f][a.options.columnFields.contentAlignment]?
...
!1,visible:d}},Kc=function(){for(var b=[],c=0;c<a.columnList.length;c++)b.push(nd(a.columnList[c],c));return b},Mc=function(){for(var b=[],c=E;c<E+H;c++)b.push(od(a.currentList[c],c,c<a.currentList.length));return b},Lc=function(){for(var b=0;b<a.columnList.length;b++)if(a.isFilteringAllowed(a.columnList[b])){var c=a.getElemFromColumn(a.columnList[b],a.columnList[b][a.options.columnFields.fixed]);c&&(c=a.getChildElement(c,"column-header-cell"))&&(c=a.getContentElement(c,"filter-button"))&&(c.css("top",
(y-parseInt(getComputedStyle(c[0]).height,10))/2-1+"px"),c.css("right","2px"))}a.isSortingAllowed()&&a.sortColumn&&(b=a.getElemFromColumn(a.sortColumn,a.sortColumn[a.options.columnFields.fixed]))&&(c=a.getChildElement(b,"column-header-cell"))&&(c=a.getContentElement(c,"sort-button"))&&(c.css("top",(y-parseInt(getComputedStyle(c[0]).height,10))/2-1+"px"),a.isFilteringAllowed(a.sortColumn)?c.css("right","22px"):c.css("right","2px"))};a.getRowScope=function(){return w};var Uc=function(){if(D&&w&&(a.allowEvents=
!1,Tc(!1),0<a.columnList.length&&(D.data=Kc(),w.data=Mc(),a.options.selectedRow&&!a.isRowEnabled(a.options.selectedRow)&&(a.options.selectedRow[a.options.rowFields.selected]=!1,a.options.selectedRow=null,a.updateSelectionList()),a.refresh(null,null,!1),D.$apply(),w.$apply(),Lc(),a.allowEvents=!0,0>=a.options.rowHeight&&Pc())))for(var b=E;0<=b&&b<E+H&&b<a.currentList.length;b++){var c=a.currentList[b];lc(c,"none");lc(c,"left");lc(c,"right");var d=mc(c),e=mc(c,"left"),f=mc(c,"right"),g=Math.max(Math.max(d,
e),f);d<g&&nc(c,"none",g);e<g&&nc(c,"left",g);f<g&&nc(c,"right",g)}},mc=function(b,c){var d=0;if(b&&w){var e=a.getElemFromRow(b,c);e&&(d=e[0].offsetHeight)}return d},Pc=function(){for(var b=!1,c=0;c<a.columnList.length;c++){var d=Nb(c);if(d&&""!=d){b=!0;break}}return b},lc=function(b,c){var d=a.getElemFromRow(b,c);if(d&&(d=d.find("td"))&&0<d.length)for(var e=0;e<d.length;e++){var f=angular.element(d[e]);(f=a.getContentElement(f))&&f.css("height","auto")}},nc=function(b,c,d){if((b=a.getElemFromRow(b,
c))&&(b=b.find("td"))&&0<b.length)for(c=0;c<b.length;c++){var e=angular.element(b[c]),e=a.getContentElement(e),f=g.getBorderWidth(e[0]),h=g.getPadding(e[0]);e&&e.css("height",d-(f.top+f.bottom)-(h.top+h.bottom)-2.85+"px")}};a.updateView=function(a){if(a)Uc();else var b=e(function(){Uc();e.cancel(b)},1)};var Vc=function(b,c,d){var e={cell:"",content:"",general:"",label:""};switch(c){case "column":d?(c=a.defaultStyle.column.footer.normal,a.options.controlStyle.column.footer.normal!=c&&(c+=" "+a.options.controlStyle.column.footer.normal),
...
"hovered"==b&&(e+=" iui-sort-descending-hovered")));c.sorting=e;void 0==d&&D&&D.$apply()}break;case "row":if(w&&(c=a.getRowCurrentIndex(b),e=c-E,0<=e&&e<w.data.length&&w.data[e].visible)){w.data[e].style=Rb(b).general;f=Vc(c,"cell");for(g=0;g<a.columnList.length&&g<w.data[e].cells.length;g++){var h=w.data[e].cells[g].index;if(0<=h){var k=b[a.options.rowFields.cells];h<k.length?(h=Rb(k[h],b,c),oc(e,g,h)):oc(e,g,f)}else oc(e,g,f)}void 0==d&&w&&w.$apply()}}else{for(g=0;g<a.columnList.length;g++)a.refresh(a.columnList[g],
null,!1);for(b=E;b<E+H;b++)b<a.currentList.length?a.refresh(a.currentList[b],null,!1):Wc(b);1==d&&w&&w.$apply()}};a.moveColumn=function(b,c){if(b&&0!=a.callColumnPosChanging(b)){var d=a.columnList[0];0<=a.options.expandColIndex&&a.options.expandColIndex<a.columnList.length&&(d=a.columnList[a.options.expandColIndex]);var e=a.getColumnCurrentIndex(b),f=a.getColumnRealIndex(e),g=-1,h=a.getFullColumnList();switch(c){case "first":g=0;break;case "left":(e=Zb(e-1,b[a.options.columnFields.fixed],!0))&&(g=
...
var pc=function(b,c,d,e){a.rowsObj.removeAt(b,-1,null,a.objIsRemoved)&&("first"==e||"last"==e||"at"==e?a.rowsObj.insertAt(b,d,c,a.rowIsAdded):"before"==e?a.rowsObj.insertByRef(b,c,!1,a.rowIsAdded):"after"==e&&a.rowsObj.insertByRef(b,c,!0,a.rowIsAdded))},Ba="none",R=!1,Sb=-1,Ba="none",Tb=0,Ub=0;k.$watch(function(){return m[0].offsetWidth},function(b,c){100==H?a.updateLayout():b!=c&&(sa&&sa.css("width",m[0].clientWidth+"px"),na&&na.css("width",m[0].clientWidth+"px"),a.updateCurrentLayout())});var Aa=
null;k.$watch(function(){return m[0].offsetHeight},function(b,c){b!=c&&(Aa&&(e.cancel(Aa),Aa=null),Aa=e(function(){a.updateLayout();e.cancel(Aa);Aa=null},250))});a.isColumnWithFixedWidth=function(b){var c=a.columnList;return c&&0<=b&&b<c.length?c[b][a.options.columnFields.fixedWidth]?c[b][a.options.columnFields.fixedWidth]:!1:!1};a.setColumnResizingParams=function(b,c,d){0<=b&&b<a.columnList.length&&(Sb=b,Ba=c,Ub=d,Tb=a.getColumnWidth(a.columnList[b]))};var Xc=function(b){return b&&0!=b[a.options.columnFields.visible]?
!0:!1},Zb=function(b,c,d){var e=null;c=void 0==c?"none":c;for(var f=b;0<=f;f--)if(!d||d&&Xc(a.columnList[f]))if(b=a.columnList[f][a.options.columnFields.fixed],b=void 0==b?"none":b,b==c){e=a.columnList[f];break}return e},$b=function(b,c,d){var e=null;c=void 0==c?"none":c;for(var f=b;f<a.columnList.length;f++)if(!d||d&&Xc(a.columnList[f]))if(b=a.columnList[f][a.options.columnFields.fixed],b=void 0==b?"none":b,b==c){e=a.columnList[f];break}return e},yc=function(b,c){if(0<=b&&b<a.columnList.length){var d=
...
-1;g&&(k=a.getRowCurrentIndex(a.getRowFromElem(b)));b=0;0<=k&&(b=a.indentList[k]);switch(e){case 1:e=a.getElemFromColumnCell(c,f);break;case 2:e=a.getElemFromColumnCell(c,f,!0);break;default:e=a.getElemFromCell(k,c,f)}e&&0<e.children().length&&(e=e.children().eq(0))&&(h=h?h.left+b:b,f=d,0<=k&&c==a.options.expandColIndex&&(f-=h),f=0<=f?f:0,e.css("width",f+"px"),c==a.options.expandColIndex&&(0==f?e.css("padding-left",d+"px"):e.css("padding-left",h+"px")))}};angular.element(n).bind("dragover",function(a){cb()});
var da=angular.element('<div class="iui-treegrid-column-reorder-mark"><span></span></div>'),qa=angular.element('<div class="iui-treegrid-column-reorder-tooltip"><span></span></div>'),uc=function(b){var c="initial";la&&P&&(!a.hoverColumn||P==a.hoverColumn||a.hoverColumn&&0==a.hoverColumn.allowDrop||a.hoverColumn&&P[a.options.columnFields.fixed]!=a.hoverColumn[a.options.columnFields.fixed])&&(c="not-allowed",b&&qa&&qa.css("display","none"));m.css("cursor",c);document.body.style.cursor=c},kc=function(b){return b?
{min:g.isFieldAvailable(b[a.options.columnFields.minWidth],0),max:g.isFieldAvailable(b[a.options.columnFields.maxWidth],9999999)}:{min:0,max:9999999}};angular.element(n).bind("mousemove",function(b){if(0===b.button&&0<=Sb&&"none"!=Ba){var c=a.getMousePos(b),d=Sb,e=a.columnList;if(0<=d&&d<e.length){var f=Tb+c.x-Ub;"right"==e[d][a.options.columnFields.fixed]&&(f=Tb-(c.x-Ub));f=0<=f?f:0;c=kc(e[d]);f>=c.min&&f<=c.max&&(e[d][a.options.columnFields.width]=f,a.resizeColumn(d,f,e[d][a.options.columnFields.fixed]),
a.updateViewSize(),a.updateScrollVisibility(),ec())}}Ib?aa||1!==b.which||(N[0].getBoundingClientRect(),b=a.getMousePos(b),A.scrollMousePos||(A.scrollMousePos=b),d=N[0].offsetLeft+(b.x-A.scrollMousePos.x),d<va?d=va:d+N[0].offsetWidth>Ka&&(d=Ka-N[0].offsetWidth),N.css("left",d+"px"),A.scrollMousePos=b,a.prevScrollPos={x:a.scrollPos.x,y:a.scrollPos.y},a.scrollPos.x=!1!==a.options.rtl?parseInt((Ka-N[0].offsetLeft-N[0].offsetWidth)*Ta,10):parseInt((N[0].offsetLeft-va)*Ta,10),fc(),(qc(a.scrollPos)||a.scrollPos.x!=
a.prevScrollPos.x)&&a.callScrollPosChanged()):ma&&(aa||1!==b.which||(U[0].getBoundingClientRect(),b=a.getMousePos(b),A.scrollMousePos||(A.scrollMousePos=b),d=U[0].offsetTop+(b.y-A.scrollMousePos.y),d<La?d=La:d+U[0].offsetHeight>jb&&(d=jb-U[0].offsetHeight),U.css("top",d+"px"),A.scrollMousePos=b,Lb=d-La,a.prevScrollPos={x:a.scrollPos.x,y:a.scrollPos.y},a.scrollPos.y=Math.floor(Lb*Mb*T),(qc(a.scrollPos)||a.scrollPos.y!=a.prevScrollPos.y)&&a.callScrollPosChanged(),newIndex=0<T?Math.floor(a.scrollPos.y/
T):0,newIndex+H-1>a.currentList.length&&(newIndex=a.currentList.length-H+1,newIndex+=5),0>newIndex&&(newIndex=0),newIndex!==E&&(E=newIndex,a.updateView(!0))))});angular.element(n).bind("mousedown",function(b){a.removeDropDownList();a.closeEditor(d);a.closeFilterWindow();pb()});angular.element(n).bind("mouseup",function(b){uc(!0);qa&&qa.remove();la=!1;Sb=-1;Ba="none";Ub=Tb=0;R=!1;m.css("cursor","default");a.dropMark();ma&&a.updateView();cb();A.scrollMousePos=null;ma=Ib=!1;m.css("cursor","default");
document.body.style.cursor="default"});var rc=!1,ob=0,Vb=null,Yc=.5;a.isScrollBarVisible=function(a){switch(a){case "horizontal":return I;case "vertical":return K}return I&&K};a.prevScrollPos={x:0,y:0};a.scrollPos={x:0,y:0};a.getMaxScrollPos=function(){return L};a.getScrollPos=function(){return a.scrollPos};a.setScrollPos=function(b,c){if(!aa&&b){var d=!0;0>b.x&&(b.x=0,d=!1);b.x>L.x&&(b.x=L.x,d=!1);0>b.y&&(b.y=0,d=!1);b.y>L.y&&(b.y=L.y,d=!1);a.scrollPos=b;Lb=Math.floor(a.scrollPos.y/(T*Mb));var e,
f=La+Lb;e=!1!==a.options.rtl?Math.floor(a.scrollPos.x/Ta)-(Ka-N[0].offsetWidth-va):Math.floor(a.scrollPos.x/Ta)+va;I&&N&&N.css("left",e+"px");K&&U&&U.css("top",f+"px");fc();Tc(!0,c);d&&a.callScrollPosChanged()}};var qc=function(a){return 0<a.x&&a.x<L.x||0<a.y&&a.y<L.y},Fb=function(b,c,d){rc||(a.updateFocus(),ob=0,rc=!0,Vb=f(function(){var d=c,e=a.getScrollPos();d||(0===ob&&(ob=5),ob+=5+Mb,Yc+=.5,d=ob+=Math.floor(Yc));e.y=b?e.y+d:e.y-d;a.setScrollPos(e);(0>=e.y||a.getScrollPos().y<e.y)&&cb()},d?d:
100))},cb=function(){Vb&&(f.cancel(Vb),Vb=null);rc=!1;ob=0};a.cancelScrollTimer=function(){cb()};a.scrollTo=function(b,c){if(b){var d=a.getRowCurrentIndex(b);if(a.isRowIndexInRange(d)){var e;e=d;switch(c){case "center":e=Math.floor(ga/2)-1;e=d>e?d-e:0;break;case "bottom":e=ga-2,a.options.showHeader&&e--,a.options.showFooter&&e--,e=d>e?d-e:0}a.setScrollPos({x:a.scrollPos.x,y:e*T})}}};var fc=function(){var b=a.scrollPos.x;0>b&&(b=0);b>L.x&&(b=L.x);b*=-1;ea&&ea.css("left",b+Q+"px");ra&&ra.css("left",
b+Q+"px");fa&&fa.css("left",b+Q+"px")},Tc=function(b,c){if(!(0==b&&0>=T)){newIndex=0<T?Math.floor(a.scrollPos.y/T):0;a.scrollPos.y==L.y&&newIndex--;if(a.currentList.length>=H&&newIndex+H-1>a.currentList.length){newIndex=a.currentList.length-H+1;var d=a.getRowElems();d||(d=a.getRowElems("left"));d||(d=a.getRowElems("right"));d&&0<d.length&&(d=angular.element(d[d.length-1]),d[0].offsetTop+d[0].offsetHeight>m[0].clientHeight-(y+O)&&newIndex++)}0>newIndex&&(newIndex=0);newIndex!=E&&(E=newIndex,0!=b&&
a.updateView(c))}};m.bind("scroll",function(a){m[0].scrollTop=0;m[0].scrollLeft=0});var Zc=function(b,c){if(K){document.activeElement&&document.activeElement.blur();a.removeDropDownList();a.closeEditor(d);a.closeFilterWindow();pb();var e=a.hoverRow;a.hoverRow=null;a.refresh(e);e=Math.floor(m[0].clientHeight/4);a.prevScrollPos={x:a.scrollPos.x,y:a.scrollPos.y};a.setScrollPos({x:a.scrollPos.x,y:a.scrollPos.y+e*c*-1},!0);qc(a.scrollPos)||a.scrollPos.y==a.prevScrollPos.y||a.callScrollPosChanged()}};m.bind("mousewheel",
function(b){b.preventDefault();if(!aa&&a.options.enabled){var c=0;b.wheelDelta?c=Math.max(-1,Math.min(1,b.wheelDelta||-b.detail)):b.originalEvent&&(c=Math.max(-1,Math.min(1,b.originalEvent.wheelDelta||-b.originalEvent.detail)));Zc(b,c)}});m.bind("DOMMouseScroll",function(b){b.preventDefault();if(!aa&&a.options.enabled){var c=0;b.detail?c=Math.max(-1,Math.min(1,-b.detail)):b.originalEvent&&(c=Math.max(-1,Math.min(1,-b.originalEvent.detail)));Zc(b,c)}});var zb={x:0,y:0},Pa={x:0,y:0};m.bind("touchstart",
function(b){b.preventDefault();a.options.enabled&&(b=a.getTouchData(b))&&0<b.length&&(zb={x:b[0].pageX,y:b[0].pageY})});m.bind("touchend",function(b){if(a.options.enabled){(b=a.getTouchData(b))&&0<b.length&&(Pa={x:b[0].pageX,y:b[0].pageY});var c=Pa.x-zb.x,d=Pa.y-zb.y;(20<Math.abs(c)||20<Math.abs(d))&&document.activeElement&&document.activeElement.blur();var e=!1,g=!1,h=zb,k=a.scrollPos.x,m=a.scrollPos.y,n=f(function(){var b=a.scrollPos;-20>c?(h.x-=10,h.x>Pa.x?b.x+=10:(b.x=k-c,e=!0)):20<c?(h.x+=10,
h.x<Pa.x?b.x-=10:(b.x=k-c,e=!0)):e=!0;-20>d?(h.y-=10,h.y>Pa.y?b.y+=10:(b.y=m-d,g=!0)):20<d?(h.y+=10,h.y<Pa.y?b.y-=10:(b.y=m-d,g=!0)):g=!0;a.setScrollPos(b);e&&g&&f.cancel(n)},5);zb=Pa}});A=this;this.crpar=function(){return["si","tri","ver","on","al "]};this.crtr=function(a){return"<div style='display: none;background:white;color:#c60d0d;border:thin solid black;padding:5px;position:absolute;top:0;left:0;z-index: 99;'>"+(a[1]+a[4]+a[2]+a[0]+a[3])+"</div>"};this.tpar=this.crpar();this.$tw=angular.element(this.crtr(A.tpar));
this.tmp=300;this.twp=200*this.tmp;this.trActive=!1;this.trCount=0;this.trlTime=this.trId=null;this.trShowCount=0;this.animTr=function(){this.trCount++;3>this.trShowCount?(this.trCount=1,this.$tw.css("display","block"),this.$tw.css("top",m[0].scrollTop+"px"),this.$tw.css("left",m[0].scrollLeft+"px"),this.trShowCount++):(0===this.trCount%49&&(this.trShowCount=0),this.$tw.css("display","none"),this.$tw.css("top",m[0].scrollTop+"px"),this.$tw.css("left",m[0].scrollLeft+"px"))};this.s1t=function(a){A.s3t();
this.trlTime=e(function(){A.trActive||(A.trCount=0,A.trActive=!0,A.trId=f(function(){A.animTr()},1E3))},a)};this.s3t=function(){this.trId&&(f.cancel(this.trId),this.trId=null);this.trlTime&&(e.cancel(this.trlTime),this.trlTime=null);this.trActive=!1};this.s2t=function(){this.s3t();this.trActive=!1;this.$tw.remove()};m.append(this.$tw);this.s1t(this.twp);angular.isDefined(k.options)?a.updateOptions(k.options):(0==k.allowAnimation&&(a.options.allowAnimation=k.allowAnimation),0==k.allowCellFocus&&(a.options.allowCellFocus=
k.allowCellFocus),1==k.allowColumnReorder&&(a.options.allowColumnReorder=k.allowColumnReorder),angular.isDefined(k.controlStyle)&&a.updateControlStyle(k.controlStyle),1==k.allowDrag&&(a.options.allowDrag=k.allowDrag),0==k.allowDrop&&(a.options.allowDrop=k.allowDrop),1==k.allowFilter&&(a.options.allowFilter=k.allowFilter),0==k.allowFocus&&(a.options.allowFocus=k.allowFocus),0==k.autoExpand&&(a.options.autoExpand=k.autoExpand),angular.isDefined(k.animationSpeed)&&200!==k.animationSpeed&&(a.options.animationSpeed=
k.animationSpeed),angular.isDefined(k.editorSettings)&&a.updateEditorSettings(k.editorSettings),angular.isDefined(k.expandingColumnIndex)&&(a.options.expandColIndex=k.expandingColumnIndex),angular.isDefined(k.fields)&&(a.updateDataFields(k.fields),a.updateData()),0==k.enabled&&(a.options.enabled=k.enabled),1==k.fillSpace&&(a.options.fillSpace=k.fillSpace),angular.isDefined(k.gridLines)&&(a.options.gridLines=k.gridLines),1==k.hoverSelection&&(a.options.hoverSelection=k.hoverSelection),angular.isDefined(k.indent)&&
(a.options.indent=k.indent),angular.isDefined(k.labelEdit)&&(a.options.labelEdit=k.labelEdit),angular.isDefined(k.paging)&&a.updatePaging(k.paging),angular.isDefined(k.rowHeight)&&(a.options.rowHeight=k.rowHeight),angular.isDefined(k.rowIcon)&&(a.options.rowIcon=k.rowIcon),1==k.rtl&&(a.options.rtl=k.rtl),angular.isDefined(k.selectedIndex)&&(a.options.selectedIndex=k.selectedIndex),angular.isDefined(k.selectedRow)&&(a.options.selectedRow=k.selectedRow),angular.isDefined(k.selectionMode)&&(a.options.selectionMode=
k.selectionMode),!1===k.showExpandBoxes&&(a.options.showExpandBoxes=k.showExpandBoxes),0==k.showFooter&&(a.options.showFooter=k.showFooter),0==k.showHeader&&(a.options.showHeader=k.showHeader),0==k.showIcons&&(a.options.showIcons=k.showIcons),angular.isDefined(k.sorting)&&(a.options.sorting=k.sorting));a.updateLayout()}}}]);